...
%"struct.std::pair.65.2924220" = type <{ %"struct.Luau::CodeGen::IrBuilder::ConstantKey.2924219", i32, [4 x i8] }>
%"struct.Luau::CodeGen::IrBuilder::ConstantKey.2924219" = type { i8, i64 }
...
entry:
  ...
  %5 = and i64 %4, %3
  %6 = getelementptr %struct.qht_bucket.2708813, ptr %0, i64 %5, i32 1
  ret ptr %6
}
...
entry:
  ...
  %4 = add i64 %1, 4294967295
  %5 = and i64 %4, %3
  %6 = getelementptr nusw nuw %"struct.std::pair.65.2924220", ptr %0, i64 %5
