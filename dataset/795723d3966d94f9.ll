...
entry:
  ...
  %3 = tail call float @llvm.fmuladd.f32(float %0, float 0x3F947AE000000000, float %2)
  ret float %3
}
...
entry:
  ...
  %3 = tail call noundef float @llvm.fmuladd.f32(float %0, float 5.000000e-01, float %2)
  ret float %3
}
