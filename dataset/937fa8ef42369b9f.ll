...
%struct.rb_uniform_sort_data.2600805 = type { i64, i64 }
%struct.iovec.2600959 = type { ptr, i64 }
...
entry:
  %2 = getelementptr %struct.rb_uniform_sort_data.2600805, ptr %0, i64 %1
...
entry:
  %2 = getelementptr %struct.iovec.2600959, ptr %0, i64 %1
  %3 = getelementptr i8, ptr %2, i64 16
  ret ptr %3
}
...
entry:
  %2 = getelementptr %"struct.re2::RuneRange.2602074", ptr %0, i64 %1
