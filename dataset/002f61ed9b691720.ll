...
%"class.boost::shared_ptr.29.2729059" = type { ptr, %"class.boost::detail::shared_count.2729055" }
%"class.boost::detail::shared_count.2729055" = type { ptr }
...
entry:
  ...
  %5 = getelementptr nusw %class.aiVector3t.2711808, ptr %0, i64 %4
  ret ptr %5
}
...
entry:
  %3 = icmp eq i64 %2, 0
  %4 = select i1 %3, i64 0, i64 %1
  %5 = getelementptr nusw nuw %"class.boost::shared_ptr.29.2729059", ptr %0, i64 %4
  ret ptr %5
}
