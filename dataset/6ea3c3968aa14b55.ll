...
%"class.rocksdb::Slice.2514714" = type { ptr, i64 }
%"struct.arrow::io::ReadRange.3620273" = type { i64, i64 }
...
entry:
  ...
  %7 = getelementptr nusw %"class.rocksdb::Slice.2514714", ptr %6, i64 %5
  ret ptr %7
}
...
entry:
  ...
  %5 = sub nuw nsw i64 %4, %3
  %6 = getelementptr nusw i8, ptr %0, i64 %1
  %7 = getelementptr %"struct.arrow::io::ReadRange.3620273", ptr %6, i64 %5
  ret ptr %7
}
