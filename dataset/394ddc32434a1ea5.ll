...
entry:
  ...
  %4 = getelementptr inbounds [0 x %struct._mc_resp.1792150], ptr %0, i64 0, i64 %3
  %5 = getelementptr inbounds i8, ptr %4, i64 119
  ret ptr %5
}
...
entry:
  %2 = urem i16 %1, 42
  %3 = zext nneg i16 %2 to i64
  %4 = getelementptr [42 x %struct.minstrel_mcs_group_data.1995196], ptr %0, i64 0, i64 %3
