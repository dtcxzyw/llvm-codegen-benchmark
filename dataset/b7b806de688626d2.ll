...
; abseil-cpp/optimized/uniform_real_distribution_test.cc.ll
; Function Attrs: nounwind
define i1 @func00000000000003db(float %0) #0 {
entry:
  %1 = call i1 @llvm.is.fpclass.f32(float %0, i32 879)
  ret i1 %1
}
...
entry:
  %1 = call i1 @llvm.is.fpclass.f32(float %0, i32 256)
  ret i1 %1
}
...
; Function Attrs: nounwind
define i1 @func0000000000000306(float %0) #0 {
entry:
  %1 = call i1 @llvm.is.fpclass.f32(float %0, i32 387)
  ret i1 %1
}
