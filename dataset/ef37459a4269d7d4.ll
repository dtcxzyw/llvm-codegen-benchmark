...
entry:
  %3 = call noundef i64 @llvm.cttz.i64(i64 %2, i1 true), !range !0
  %4 = or disjoint i64 %3, %1
  %5 = getelementptr %"class.ue2::bitfield.2239698", ptr %0, i64 %4
  ret ptr %5
}
...
entry:
  %3 = call noundef i64 @llvm.cttz.i64(i64 %2, i1 true), !range !0
  %4 = or disjoint i64 %3, %1
  %5 = getelementptr inbounds %"class.boost::dynamic_bitset.2239734", ptr %0, i64 %4
  ret ptr %5
}
