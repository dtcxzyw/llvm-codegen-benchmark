...
%struct.i915_engine_class_instance.2003304 = type { i16, i16 }
...
entry:
  ...
  %6 = getelementptr [2048 x [3 x i64]], ptr %0, i64 0, i64 %5
  ret ptr %6
}
...
entry:
  ...
  %4 = shl i64 %3, 32
  %5 = ashr exact i64 %4, 32
  %6 = getelementptr [0 x %struct.i915_engine_class_instance.2003304], ptr %0, i64 0, i64 %5
  ret ptr %6
}
