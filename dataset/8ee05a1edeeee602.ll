...
entry:
  ...
  %4 = shl nuw i64 1, %3
  %5 = getelementptr nusw %"struct.rocksdb::StatisticsImpl::StatisticsData.2509692", ptr %1, i64 %4
  %6 = icmp eq ptr %5, %0
  ret i1 %6
}
...
entry:
  %3 = zext nneg i32 %2 to i64
  %4 = shl nuw i64 1, %3
  %5 = getelementptr nusw %"struct.rocksdb::clock_cache::FixedHyperClockTable::HandleImpl.2514957", ptr %1, i64 %4
  %6 = icmp ugt ptr %5, %0
  ret i1 %6
}
...
entry:
  %3 = zext nneg i32 %2 to i64
  %4 = shl nuw i64 1, %3
  %5 = getelementptr %struct.page.3346644, ptr %1, i64 %4
  %6 = icmp ugt ptr %5, %0
  ret i1 %6
}
