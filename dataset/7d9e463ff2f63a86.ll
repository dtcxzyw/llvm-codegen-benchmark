...
entry:
  ...
  %5 = zext i32 %4 to i64
  %6 = getelementptr nusw nuw [32768 x %"class.openvdb::v11_0::tree::NodeUnion.2710893"], ptr %0, i64 0, i64 %5
  ret ptr %6
}
...
entry:
  ...
  %6 = getelementptr nusw nuw [1 x %"struct.OT::OffsetTo.161.2729504"], ptr %0, i64 0, i64 %5
  ret ptr %6
}
