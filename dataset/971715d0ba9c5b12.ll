...
%struct.dtObstacleAvoidanceParams.3108490 = type { float, float, float, float, float, float, i8, i8, i8, i8 }
...
entry:
  ...
  %5 = getelementptr nusw nuw [1 x %"struct.OT::IntType.2741997"], ptr %4, i64 0, i64 %3
...
entry:
  ...
  %5 = getelementptr nusw nuw [8 x %struct.dtObstacleAvoidanceParams.3108490], ptr %4, i64 0, i64 %3
  %6 = select i1 %0, ptr %5, ptr null
  ret ptr %6
}
