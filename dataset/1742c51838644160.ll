...
entry:
  ...
  %6 = getelementptr nusw nuw [8 x %"class.folly::hazptr_detail::shared_head_only_list.2684612"], ptr %5, i64 0, i64 %4
  ret ptr %6
}
...
entry:
  ...
  %6 = getelementptr [15 x %struct.OHCIPort.2706526], ptr %5, i64 0, i64 %4
  ret ptr %6
}
