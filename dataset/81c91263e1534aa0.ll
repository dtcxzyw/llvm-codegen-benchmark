...
%struct.llama_token_data.2186193 = type { i32, float, float }
%"struct.ue2::TriggerInfo.2238693" = type { i8, i32, i32 }
...
entry:
  ...
  %3 = getelementptr inbounds %struct.llama_token_data.2186193, ptr %0, i64 %2, i32 2
  ret ptr %3
}
...
entry:
  %2 = sdiv i64 %1, 2
  %3 = getelementptr inbounds %"struct.ue2::TriggerInfo.2238693", ptr %0, i64 %2, i32 1
  ret ptr %3
}
