...
%"struct.llvh::detail::DenseMapPair.607.1844498" = type { %"struct.std::pair.608.1844499" }
%"struct.std::pair.608.1844499" = type { ptr, %"struct.std::pair.579.1844500" }
%"struct.std::pair.579.1844500" = type { i32, i32 }
