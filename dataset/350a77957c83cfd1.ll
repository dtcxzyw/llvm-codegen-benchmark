...
%"class.gmx::AnalysisDataValue.3182932" = type { float, float, %"class.gmx::FlagsTemplate.3182933" }
%"class.gmx::FlagsTemplate.3182933" = type { i64 }
...
entry:
  %3 = sext i32 %2 to i64
  %4 = getelementptr %"class.gmx::AnalysisDataValue.3182932", ptr %0, i64 %3
  %5 = sext i32 %1 to i64
  %6 = getelementptr %"class.gmx::AnalysisDataValue.3182932", ptr %4, i64 %5, i32 2
  ret ptr %6
}
...
entry:
  %3 = sext i32 %2 to i64
  %4 = getelementptr nusw %struct.TPL_MV_REF.3194448, ptr %0, i64 %3
  %5 = sext i32 %1 to i64
  %6 = getelementptr %struct.TPL_MV_REF.3194448, ptr %4, i64 %5, i32 1
  ret ptr %6
}
