...
%"struct.std::atomic.614.2524544" = type { %"struct.std::__atomic_base.615.2524546" }
%"struct.std::__atomic_base.615.2524546" = type { ptr }
...
entry:
  ...
  %3 = xor i64 %2, 63
  %4 = getelementptr nusw %"struct.std::atomic.405.2521434", ptr %0, i64 %3
  ret ptr %4
}
...
entry:
  ...
  %3 = xor i64 %2, 63
  %4 = getelementptr nusw %"struct.std::atomic.614.2524544", ptr %0, i64 %3
  ret ptr %4
}
