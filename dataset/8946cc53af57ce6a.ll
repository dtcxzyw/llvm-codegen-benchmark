...
%"struct.re2::Splice.2486349" = type { ptr, ptr, i32, i32 }
...
entry:
  %3 = tail call i64 @llvm.umin.i64(i64 %1, i64 384307168202282325)
  %4 = icmp ult i64 %1, %2
  %5 = select i1 %4, i64 384307168202282325, i64 %3
  %6 = getelementptr nusw %"struct.re2::Splice.2486349", ptr %0, i64 %5
  ret ptr %6
}
...
entry:
  %3 = call i64 @llvm.umin.i64(i64 %1, i64 1152921504606846975)
  %4 = icmp ult i64 %1, %2
  %5 = select i1 %4, i64 1152921504606846975, i64 %3
  %6 = getelementptr nusw nuw %"class.QuantLib::Date.2718310", ptr %0, i64 %5
  ret ptr %6
}
