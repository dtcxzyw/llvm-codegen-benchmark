...
%"struct.std::atomic.159.1574543" = type { %"struct.std::__atomic_base.160.1574544" }
%"struct.std::__atomic_base.160.1574544" = type { ptr }
...
entry:
  ...
  %3 = sext i32 %2 to i64
  %4 = getelementptr inbounds i8, ptr %0, i64 8
  %5 = getelementptr inbounds [1 x %"struct.std::atomic.159.1574543"], ptr %4, i64 0, i64 %3
  ret ptr %5
}
...
entry:
  %2 = add nsw i32 %1, -1
  %3 = sext i32 %2 to i64
  %4 = getelementptr inbounds i8, ptr %0, i64 3544
...
entry:
  ...
  %3 = sext i32 %2 to i64
  %4 = getelementptr inbounds i8, ptr %0, i64 8216
