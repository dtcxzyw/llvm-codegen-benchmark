...
; Function Attrs: nounwind
define i1 @func0000000000000343(float %0, float %1) #0 {
entry:
  %2 = tail call noundef float @llvm.fabs.f32(float %1)
  %3 = tail call noundef float @llvm.fabs.f32(float %0)
  %4 = fcmp ogt float %3, %2
  %5 = select i1 %4, float %3, float %2
  %6 = fcmp ult float %5, 0x4320000000000000
  ret i1 %6
}
...
; gromacs/optimized/slartg.cpp.ll
; Function Attrs: nounwind
define i1 @func0000000000000345(float %0, float %1) #0 {
entry:
  %2 = tail call noundef float @llvm.fabs.f32(float %1)
  %3 = tail call noundef float @llvm.fabs.f32(float %0)
  %4 = fcmp ogt float %3, %2
  %5 = select i1 %4, float %3, float %2
  %6 = fcmp ugt float %5, 0x3CC0000000000000
  ret i1 %6
}
