...
entry:
  ...
  %6 = add nsw i64 %3, %1
  %7 = getelementptr nusw [0 x { i64, i64 }], ptr %5, i64 0, i64 %6
  ret ptr %7
}
...
entry:
  %3 = lshr i64 %2, 1
  %4 = sub nsw i64 0, %3
  %5 = getelementptr nusw { { i8, [23 x i8] } }, ptr %0, i64 %4
  %6 = add nsw i64 %3, %1
  %7 = getelementptr nusw nuw [0 x { { i8, [23 x i8] } }], ptr %5, i64 0, i64 %6
  ret ptr %7
}
