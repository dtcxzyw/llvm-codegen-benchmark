...
entry:
  ...
  %6 = call double @llvm.fma.f64(double %5, double %0, double 0x3FE55555555555FF)
  ret double %6
}
...
; Function Attrs: nounwind
define float @func000000000000001f(float %0, float %1) #0 {
entry:
  ...
  %6 = tail call noundef float @llvm.fma.f32(float %5, float %0, float 0x3F62F64020000000)
  ret float %6
}
