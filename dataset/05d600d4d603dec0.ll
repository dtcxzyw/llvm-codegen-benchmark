...
%"struct.metaspace::InUseChunkStats.2739996" = type { i32, i64, i64, i64, i64, i64 }
...
%struct.cfg80211_assoc_link.3541800 = type { ptr, ptr, i64, i8, i32 }
...
entry:
  %2 = sext i8 %1 to i64
  %3 = getelementptr nusw [15 x %"struct.metaspace::InUseChunkStats.2739996"], ptr %0, i64 0, i64 %2
...
entry:
  %2 = sext i8 %1 to i64
  %3 = getelementptr nuw [100 x %struct.dt_liquify_path_data_t.2873560], ptr %0, i64 0, i64 %2, i32 0, i32 2
  ret ptr %3
}
...
entry:
  %2 = sext i8 %1 to i64
  %3 = getelementptr [100 x %struct.dt_liquify_path_data_t.2873560], ptr %0, i64 0, i64 %2, i32 0, i32 6
  ret ptr %3
}
...
entry:
  %2 = sext i8 %1 to i64
  %3 = getelementptr [15 x %struct.cfg80211_assoc_link.3541800], ptr %0, i64 0, i64 %2, i32 2
  ret ptr %3
}
