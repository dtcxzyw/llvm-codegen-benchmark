...
entry:
  ...
  %4 = sub nuw i64 %2, %3
  %5 = call i64 @llvm.umax.i64(i64 %3, i64 range(i64 -44343134792571036, 44343139087538334) %4)
  ret i64 %5
}
...
entry:
  ...
  %5 = call i64 @llvm.umax.i64(i64 %3, i64 range(i64 -25063510969714063, 25063515264681361) %4)
  ret i64 %5
}
