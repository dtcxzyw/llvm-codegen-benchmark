...
entry:
  %3 = sub nsw i64 0, %2
  %4 = getelementptr %struct.NetClientState.2706015, ptr %0, i64 %3
  %5 = sub i64 0, %1
  %6 = getelementptr i8, ptr %4, i64 %5
  ret ptr %6
}
...
entry:
  %3 = sub i64 0, %2
  %4 = getelementptr nusw %"struct.std::pair.138.2821318", ptr %0, i64 %3
  %5 = sub i64 0, %1
  %6 = getelementptr nusw %"struct.std::pair.138.2821318", ptr %4, i64 %5
  ret ptr %6
}
...
entry:
  %3 = sub nsw i64 0, %2
  %4 = getelementptr %"class.llvm::Use.3191528", ptr %0, i64 %3
  %5 = sub nsw i64 0, %1
