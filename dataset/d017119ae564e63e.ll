...
entry:
  %3 = sub i64 %1, %2
  %4 = getelementptr inbounds { { i64 }, { { [3 x i64] } } }, ptr %0, i64 %3, i32 1, i32 0, i32 0, i64 2
  ret ptr %4
}
...
entry:
  %3 = sub nsw i64 %1, %2
  %4 = getelementptr inbounds %"class.casadi::Matrix.2308010", ptr %0, i64 %3, i32 2, i32 0, i32 0, i32 0, i32 1
  ret ptr %4
}
