...
entry:
  ...
  %4 = getelementptr [1 x %struct.rb_backtrace_location_struct.2601565], ptr %3, i64 0, i64 %0
  %5 = sub i64 0, %1
  %6 = getelementptr %struct.rb_backtrace_location_struct.2601565, ptr %4, i64 %5
  ret ptr %6
}
...
entry:
  ...
  %4 = getelementptr [513 x %struct.mi_page_s.3949240], ptr %3, i64 0, i64 %0
  %5 = sub nsw i64 0, %1
  %6 = getelementptr i8, ptr %4, i64 %5
  ret ptr %6
}
...
entry:
  %3 = getelementptr nusw nuw i8, ptr %2, i64 264
  %4 = getelementptr nusw nuw [513 x %struct.mi_page_s.4024172], ptr %3, i64 0, i64 %0
  %5 = sub nsw i64 0, %1
  %6 = getelementptr nusw i8, ptr %4, i64 %5
  ret ptr %6
}
