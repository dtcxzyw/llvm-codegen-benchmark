...
entry:
  %3 = shl nuw i64 1, %2
  %4 = getelementptr nusw %"struct.rocksdb::StatisticsImpl::StatisticsData.2624810", ptr %1, i64 %3
  %5 = icmp eq ptr %0, %4
  ret i1 %5
}
...
entry:
  %3 = shl nuw i64 1, %2
  %4 = getelementptr nusw %"struct.rocksdb::clock_cache::FixedHyperClockTable::HandleImpl.2630033", ptr %1, i64 %3
  %5 = icmp ult ptr %0, %4
  ret i1 %5
}
...
entry:
  %3 = shl nuw i64 1, %2
  %4 = getelementptr %struct.page.3535177, ptr %1, i64 %3
  %5 = icmp ult ptr %0, %4
  ret i1 %5
}
