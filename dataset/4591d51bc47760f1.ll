...
%struct.UnsetAddr.2485370 = type { i32, ptr }
%struct.pm_constant_t.2485449 = type { ptr, i64 }
%struct.raw_extension_st.2518892 = type { %struct.PACKET.2518893, i32, i32, i32, i64 }
%struct.PACKET.2518893 = type { ptr, i64 }
%"struct.ncnn::custom_layer_registry_entry.2636478" = type { ptr, ptr, ptr, ptr }
%"class.std::vector.85.2723534" = type { %"struct.std::_Vector_base.86.2723535" }
%"struct.std::_Vector_base.86.2723535" = type { %"struct.std::_Vector_base<double, std::allocator<double>>::_Vector_impl.2723536" }
%"struct.std::_Vector_base<double, std::allocator<double>>::_Vector_impl.2723536" = type { %"struct.std::_Vector_base<double, std::allocator<double>>::_Vector_impl_data.2723537" }
%"struct.std::_Vector_base<double, std::allocator<double>>::_Vector_impl_data.2723537" = type { ptr, ptr, ptr }
...
%"class.llvm::MachineOperand.3085640" = type { i32, %union.anon.285.3085641, ptr, %"union.llvm::MachineOperand::ContentsUnion.3085642" }
%union.anon.285.3085641 = type { i32 }
%"union.llvm::MachineOperand::ContentsUnion.3085642" = type { %"class.llvm::ArrayRef.286.3085643" }
%"class.llvm::ArrayRef.286.3085643" = type { ptr, i64 }
...
entry:
  %2 = zext nneg i32 %1 to i64
  %3 = getelementptr %struct.UnsetAddr.2485370, ptr %0, i64 %2, i32 1
  ret ptr %3
}
...
entry:
  %2 = zext i32 %1 to i64
  %3 = getelementptr %struct.pm_constant_t.2485449, ptr %0, i64 %2, i32 1
  ret ptr %3
}
...
entry:
  %2 = zext i32 %1 to i64
  %3 = getelementptr %struct.raw_extension_st.2518892, ptr %0, i64 %2, i32 0, i32 1
  ret ptr %3
}
...
entry:
  %2 = zext nneg i32 %1 to i64
  %3 = getelementptr %"struct.ncnn::custom_layer_registry_entry.2636478", ptr %0, i64 %2, i32 1
  ret ptr %3
}
...
entry:
  %2 = zext i32 %1 to i64
  %3 = getelementptr %"class.std::vector.85.2723534", ptr %0, i64 %2, i32 0, i32 0, i32 0, i32 2
  ret ptr %3
}
...
entry:
  %2 = zext nneg i32 %1 to i64
  %3 = getelementptr %"class.QuantLib::Matrix.2738555", ptr %0, i64 %2, i32 2
  ret ptr %3
}
...
entry:
  %2 = zext i32 %1 to i64
  %3 = getelementptr nusw %"class.clang::DeclAccessPair.2944379", ptr %0, i64 %2
...
entry:
  %2 = zext nneg i32 %1 to i64
  %3 = getelementptr %"class.llvm::MachineOperand.3085640", ptr %0, i64 %2, i32 3
  ret ptr %3
}
