...
%struct.io_uring_cqe.2593283 = type { i64, i32, i32 }
...
entry:
  %3 = and i32 %1, %2
  %4 = zext i32 %3 to i64
  %5 = getelementptr %"class.rocksdb::clock_cache::ClockCacheShard.2514979", ptr %0, i64 %4, i32 2
  ret ptr %5
}
...
entry:
  %3 = and i32 %1, %2
  %4 = zext i32 %3 to i64
  %5 = getelementptr %struct.io_uring_cqe.2593283, ptr %0, i64 %4, i32 1
  ret ptr %5
}
...
entry:
  %3 = and i32 %1, %2
  %4 = zext i32 %3 to i64
  %5 = getelementptr %"struct.llvm::detail::DenseMapPair.246.2944939", ptr %0, i64 %4, i32 0, i32 0, i32 1
  ret ptr %5
}
...
entry:
  %3 = and i32 %1, %2
  %4 = zext nneg i32 %3 to i64
  %5 = getelementptr %"struct.llvm::detail::DenseMapPair.2946988", ptr %0, i64 %4, i32 0, i32 1
  ret ptr %5
}
...
entry:
  %3 = and i32 %1, %2
  %4 = zext i32 %3 to i64
  %5 = getelementptr %"struct.llvm::detail::DenseMapPair.2967298", ptr %0, i64 %4, i32 0, i32 0, i32 1
  ret ptr %5
}
...
entry:
  %3 = and i32 %1, %2
  %4 = zext nneg i32 %3 to i64
  %5 = getelementptr %"struct.llvm::detail::DenseMapPair.2989010", ptr %0, i64 %4, i32 0, i32 0, i32 0, i32 1, i32 2
  ret ptr %5
}
