...
entry:
  %3 = tail call double @llvm.fmuladd.f64(double %2, double 0x3FD34413509F79FB, double 0x3FC68A288B60C8B3)
  %4 = tail call double @llvm.fmuladd.f64(double %1, double 0x3FD287A7636F4361, double %3)
  %5 = fptosi double %4 to i32
  %6 = add nsw i32 %0, %5
  %7 = add i32 %6, 99
  ret i32 %7
