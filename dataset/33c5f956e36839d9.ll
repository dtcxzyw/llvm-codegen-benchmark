...
entry:
  ...
  %7 = getelementptr [2 x %struct.e1000_adv_tx_context_desc.2705959], ptr %5, i64 0, i64 %6
  ret ptr %7
}
...
entry:
  ...
  %5 = getelementptr nusw nuw [1 x %"struct.OT::AxisValueMap.2736846"], ptr %4, i64 0, i64 %3
  %6 = zext i32 %0 to i64
  %7 = getelementptr nusw nuw [2 x %"struct.OT::HBFixed.2736843"], ptr %5, i64 0, i64 %6
  ret ptr %7
}
...
entry:
  ...
  %6 = zext nneg i32 %0 to i64
  %7 = getelementptr nusw nuw [41 x %"struct.rawspeed::(anonymous namespace)::int_pair.2872897"], ptr %5, i64 0, i64 %6
  ret ptr %7
}
...
entry:
  ...
  %5 = getelementptr nusw nuw [2 x %"struct.std::array.9.3496162"], ptr %4, i64 0, i64 %3
  %6 = zext i32 %0 to i64
  %7 = getelementptr nusw nuw [5 x %"class.absl::debian2::optional.3496119"], ptr %5, i64 0, i64 %6
  ret ptr %7
}
...
entry:
  ...
  %5 = getelementptr [3 x %struct.anon.3556608], ptr %4, i64 0, i64 %3
  %6 = zext nneg i32 %0 to i64
  %7 = getelementptr [11 x %struct.ttm_pool_type.3556604], ptr %5, i64 0, i64 %6
  ret ptr %7
}
