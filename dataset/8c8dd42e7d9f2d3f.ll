...
entry:
  %3 = getelementptr nusw %"struct.rocksdb::TableReader::Anchor.2504818", ptr %1, i64 %2
...
entry:
  %3 = getelementptr nusw { { i8, [15 x i8] }, { { i8, [23 x i8] } }, { i8, [23 x i8] }, { i32, { { i32, i32 }, i16, [1 x i16] }, { { { i32, i32 }, i16, [1 x i16] }, {} } }, i8, i8, [2 x i8] }, ptr %1, i64 %2
  %4 = ptrtoint ptr %3 to i64
  %5 = ptrtoint ptr %0 to i64
  %6 = sub i64 %4, %5
  %7 = udiv i64 %6, 96
...
entry:
  %3 = getelementptr %"class.std::vector.0.2721086", ptr %1, i64 %2
  %4 = ptrtoint ptr %3 to i64
  %5 = ptrtoint ptr %0 to i64
  %6 = sub i64 %4, %5
