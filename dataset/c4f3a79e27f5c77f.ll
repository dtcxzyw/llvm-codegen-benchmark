...
entry:
  ...
  %4 = getelementptr nusw nuw i8, ptr %1, i64 4
  %5 = getelementptr nusw [3 x [20 x %struct.dt_iop_colorzones_node_t.2874016]], ptr %4, i64 0, i64 %3
  %6 = getelementptr nuw %struct.dt_iop_colorzones_node_t.2874016, ptr %5, i64 %0, i32 1
  ret ptr %6
}
...
entry:
  ...
  %4 = getelementptr nusw nuw i8, ptr %1, i64 4
  %5 = getelementptr nusw [3 x [20 x %struct.dt_iop_colorzones_node_t.2874016]], ptr %4, i64 0, i64 %3
  %6 = getelementptr %struct.dt_iop_colorzones_node_t.2874016, ptr %5, i64 %0, i32 1
  ret ptr %6
}
...
entry:
  ...
  %4 = getelementptr nusw nuw i8, ptr %1, i64 4
  %5 = getelementptr nusw [3 x [20 x %struct.dt_iop_colorzones_node_t.2874016]], ptr %4, i64 0, i64 %3
  %6 = getelementptr nusw %struct.dt_iop_colorzones_node_t.2874016, ptr %5, i64 %0
  %7 = getelementptr i8, ptr %6, i64 8
  ret ptr %7
}
...
entry:
  ...
  %5 = getelementptr [0 x %struct.flow_action_entry.3533033], ptr %4, i64 0, i64 %3
  %6 = getelementptr %struct.flow_action_entry.3533033, ptr %5, i64 %0, i32 4
  ret ptr %6
}
