...
entry:
  ...
  %5 = getelementptr nusw [256 x %struct.crawlerstats_t.2897102], ptr %4, i64 0, i64 %3
...
entry:
  ...
  %6 = getelementptr [8 x %struct.gmx_domdec_zone_size.3356896], ptr %5, i64 0, i64 %0
  ret ptr %6
}
...
entry:
  %3 = sext i32 %2 to i64
  %4 = getelementptr nusw nuw i8, ptr %1, i64 824
  %5 = getelementptr nusw [8 x %struct.gmx_domdec_zone_size.3356896], ptr %4, i64 0, i64 %3
