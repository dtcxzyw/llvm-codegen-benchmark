...
entry:
  %2 = tail call i64 @llvm.fshl.i64(i64 %1, i64 %1, i64 17)
  %3 = tail call i64 @llvm.fshl.i64(i64 %0, i64 %0, i64 21)
  %4 = xor i64 %3, %2
  ret i64 %4
}
...
entry:
  %2 = tail call noundef i64 @llvm.fshl.i64(i64 %1, i64 %1, i64 21)
  %3 = tail call noundef i64 @llvm.fshl.i64(i64 %0, i64 %0, i64 17)
  %4 = xor i64 %3, %2
  ret i64 %4
}
