...
%"struct.std::pair.1925603" = type { i32, i32 }
...
entry:
  ...
  %4 = ashr i64 %3, 3
  %5 = or i64 %4, 1
  %6 = getelementptr %"class.re2::SparseArray<int>::IndexValue.1554803", ptr %0, i64 %5
...
entry:
  ...
  %5 = or i64 %4, 1
  %6 = getelementptr %"struct.std::pair.1925603", ptr %0, i64 %5
  %7 = getelementptr i8, ptr %6, i64 -16
  ret ptr %7
}
