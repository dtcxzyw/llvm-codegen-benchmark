...
entry:
  %2 = ashr i64 %1, 32
  %3 = getelementptr [16 x %struct.XHCIInterrupter.2706965], ptr %0, i64 0, i64 %2, i32 6
  ret ptr %3
}
...
entry:
  %2 = ashr exact i64 %1, 32
  %3 = getelementptr [5 x %"struct.tf::ObjectPool<tf::Node>::Blocklist.3063081"], ptr %0, i64 0, i64 %2, i32 1
  ret ptr %3
}
