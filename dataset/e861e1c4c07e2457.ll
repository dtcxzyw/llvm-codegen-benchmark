...
entry:
  %3 = lshr i64 %2, 1
  %4 = sub nsw i64 0, %3
  %5 = getelementptr nusw { i64, i64 }, ptr %1, i64 %4
  %6 = getelementptr nusw [0 x { i64, i64 }], ptr %5, i64 0, i64 %0
  ret ptr %6
}
...
entry:
  %3 = lshr i64 %2, 1
  %4 = sub nsw i64 0, %3
  %5 = getelementptr nusw { { i8, [23 x i8] } }, ptr %1, i64 %4
  %6 = getelementptr nusw nuw [0 x { { i8, [23 x i8] } }], ptr %5, i64 0, i64 %0
  ret ptr %6
}
