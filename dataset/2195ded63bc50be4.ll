...
entry:
  ...
  %6 = getelementptr inbounds [15 x %"union.std::aligned_storage<16, 8>::type.1640670"], ptr %4, i64 0, i64 %5
...
entry:
  %3 = getelementptr %struct.AHCIDevice.1665213, ptr %1, i64 %2
  %4 = getelementptr inbounds i8, ptr %3, i64 2496
  %5 = zext nneg i8 %0 to i64
  %6 = getelementptr [32 x %struct.NCQTransferState.1665217], ptr %4, i64 0, i64 %5
...
entry:
  ...
  %4 = getelementptr inbounds i8, ptr %3, i64 16
  %5 = zext nneg i32 %0 to i64
  %6 = getelementptr inbounds [15 x %"union.std::aligned_storage<16, 8>::type.1724392"], ptr %4, i64 0, i64 %5
...
entry:
  ...
  %5 = zext i8 %0 to i64
  %6 = getelementptr [17 x %struct.bio_vec.1994582], ptr %4, i64 0, i64 %5
