...
entry:
  ...
  %5 = add nsw i64 %1, %2
  %6 = getelementptr nusw [0 x { i64, i64 }], ptr %4, i64 0, i64 %5
  ret ptr %6
}
...
entry:
  %3 = sub nsw i64 0, %1
  %4 = getelementptr nusw { { i8, [23 x i8] } }, ptr %0, i64 %3
  %5 = add nsw i64 %1, %2
  %6 = getelementptr nusw nuw [0 x { { i8, [23 x i8] } }], ptr %4, i64 0, i64 %5
  ret ptr %6
}
