...
%"struct.WasmEdge::RefVariant.2772638" = type { <2 x i64> }
...
entry:
  ...
  %5 = getelementptr %"struct.WasmEdge::RefVariant.2772638", ptr %4, i64 %3
  ret ptr %5
}
...
entry:
  %3 = zext i32 %2 to i64
  %4 = getelementptr i8, ptr %0, i64 %1
  %5 = getelementptr %"class.std::__cxx11::basic_string.2802868", ptr %4, i64 %3
  ret ptr %5
}
