...
entry:
  %3 = sext i32 %2 to i64
  %4 = getelementptr nusw [3 x [20 x %struct.dt_iop_tonecurve_node_t.2873179]], ptr %0, i64 0, i64 %1
  %5 = getelementptr %struct.dt_iop_tonecurve_node_t.2873179, ptr %4, i64 %3, i32 1
  ret ptr %5
}
...
entry:
  ...
  %5 = getelementptr %"struct.cv::CircleData.3731276", ptr %4, i64 %3, i32 1
  ret ptr %5
}
...
entry:
  %3 = sext i32 %2 to i64
  %4 = getelementptr [3 x %class.Polynomial.17.3820760], ptr %0, i64 0, i64 %1
  %5 = getelementptr %"struct.BSplineEvaluationData<2, BOUNDARY_NEUMANN>::BSplineComponents.3820778", ptr %4, i64 %3, i32 0, i64 0, i32 0, i64 1
  ret ptr %5
}
