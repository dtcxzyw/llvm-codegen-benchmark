...
entry:
  %3 = call float @llvm.fmuladd.f32(float %1, float 1.500000e+01, float %2)
  %4 = call float @llvm.fmuladd.f32(float %0, float 3.000000e+00, float %3)
...
entry:
  %3 = tail call float @llvm.fmuladd.f32(float %1, float 1.500000e+01, float %2)
  %4 = tail call float @llvm.fmuladd.f32(float %0, float 3.000000e+00, float %3)
