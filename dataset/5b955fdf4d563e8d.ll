...
entry:
  ...
  %5 = getelementptr nuw [3 x %struct.tinfl_huff_table.2828252], ptr %0, i64 0, i64 %1, i32 1, i64 %4
  ret ptr %5
}
...
entry:
  %3 = and i32 %2, 1
  %4 = zext nneg i32 %3 to i64
  %5 = getelementptr [3 x %struct.dd_per_prio.3557938], ptr %0, i64 0, i64 %1, i32 1, i64 %4
  ret ptr %5
}
