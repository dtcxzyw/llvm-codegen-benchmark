...
entry:
  %2 = and i8 %1, 4
  %.not = icmp eq i8 %2, 0
  %3 = select i1 %.not, i32 164480, i32 164160
  %4 = or i32 %3, %0
  ret i32 %4
}
...
entry:
  ...
  %3 = select i1 %.not.not, i8 48, i8 32
...
entry:
  %2 = and i16 %1, 256
  %.not = icmp eq i16 %2, 0
  %3 = select i1 %.not, i16 1024, i16 256
...
entry:
  %2 = and i32 %1, 896
  %3 = icmp ugt i32 %2, 383
  %4 = select i1 %3, i32 2097184, i32 32
