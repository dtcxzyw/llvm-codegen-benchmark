...
%class.SwitchRange.2634588 = type { i32, i32, i32, float }
...
entry:
  ...
  %4 = sub nsw i32 %3, %1
  %5 = sext i32 %4 to i64
  %6 = getelementptr %class.SwitchRange.2634588, ptr %0, i64 %5, i32 1
  ret ptr %6
}
...
entry:
  ...
  %4 = sub nsw i32 %3, %1
  %5 = sext i32 %4 to i64
  %6 = getelementptr %struct.DdSubtable.2764030, ptr %0, i64 %5, i32 2
  ret ptr %6
}
