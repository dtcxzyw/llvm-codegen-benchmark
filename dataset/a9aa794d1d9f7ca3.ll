...
entry:
  ...
  %7 = getelementptr nusw %"class.Ipopt::TripletToCSRConverter::TripletEntry.2496215", ptr %6, i64 %5
  ret ptr %7
}
...
entry:
  ...
  %7 = getelementptr %"class.std::vector.112.2710966", ptr %6, i64 %5
  ret ptr %7
}
