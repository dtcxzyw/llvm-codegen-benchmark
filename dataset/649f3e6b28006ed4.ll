...
entry:
  ...
  %5 = getelementptr [8 x %struct.ar_table_pair_struct.2486121], ptr %0, i64 0, i64 %4, i32 1
  ret ptr %5
}
...
entry:
  ...
  %3 = and i32 %2, 15
  %4 = zext nneg i32 %3 to i64
  %5 = getelementptr [4 x %"class.asmjit::_abi_1_10::ZoneVector.4.2488215"], ptr %0, i64 0, i64 %4, i32 0, i32 2
  ret ptr %5
}
