...
%"class.sat::literal.3443234" = type { i32 }
%union.ListCell.3468724 = type { ptr }
...
entry:
  ...
  %3 = add nsw i32 %2, -1
  %4 = zext i32 %3 to i64
  %5 = getelementptr nusw %"class.sat::literal.3443234", ptr %0, i64 %4
  ret ptr %5
}
...
entry:
  ...
  %5 = getelementptr %union.ListCell.3468724, ptr %0, i64 %4
  ret ptr %5
}
