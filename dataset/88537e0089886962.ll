...
entry:
  %2 = add nsw i64 %0, %1
  %3 = tail call i64 @llvm.fshl.i64(i64 %0, i64 %0, i64 42)
  %4 = xor i64 %3, %2
...
entry:
  %2 = tail call noundef i64 @llvm.fshl.i64(i64 %1, i64 %1, i64 16)
  %3 = add i64 %0, %1
  %4 = xor i64 %3, %2
  %5 = tail call noundef i64 @llvm.fshl.i64(i64 %4, i64 %4, i64 21)
  ret i64 %5
}
...
entry:
  %2 = add i64 %0, %1
  %3 = tail call noundef i64 @llvm.fshl.i64(i64 %0, i64 %0, i64 16)
  %4 = xor i64 %3, %2
  %5 = tail call noundef i64 @llvm.fshl.i64(i64 %4, i64 %4, i64 21)
  ret i64 %5
}
