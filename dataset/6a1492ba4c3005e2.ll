...
entry:
  ...
  %5 = getelementptr nusw %"struct.rocksdb::TableReader::Anchor.2619962", ptr %0, i64 %.neg
  ret ptr %5
}
...
entry:
  ...
  %5 = getelementptr { { { { i64, ptr }, i64 } }, {} }, ptr %0, i64 %.neg
  ret ptr %5
}
...
entry:
  ...
  %5 = getelementptr %"class.irr::core::vector3d.2691781", ptr %0, i64 %.neg
