...
entry:
  %1 = call i32 @llvm.smax.i32(i32 %0, i32 36)
...
entry:
  %1 = tail call noundef range(i32 0, -2147483648) i32 @llvm.smax.i32(i32 %0, i32 0)
...
entry:
  %1 = tail call noundef i32 @llvm.smax.i32(i32 %0, i32 211)
  %2 = add nsw i32 %1, -1
  %3 = zext nneg i32 %2 to i64
  ret i64 %3
}
