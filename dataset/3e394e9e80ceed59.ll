...
entry:
  ...
  %4 = getelementptr [4097 x i8], ptr %0, i64 0, i64 %3
...
entry:
  %2 = shl i64 %1, 32
  %3 = ashr exact i64 %2, 32
  %4 = getelementptr [16 x %struct.XHCIInterrupter.2593270], ptr %0, i64 0, i64 %3, i32 6
  ret ptr %4
}
...
entry:
  %2 = shl i64 %1, 32
  %3 = ashr exact i64 %2, 32
  %4 = getelementptr [5 x %"struct.tf::ObjectPool<tf::Node>::Blocklist.2869504"], ptr %0, i64 0, i64 %3, i32 1
  ret ptr %4
}
...
entry:
  %2 = shl i64 %1, 32
  %3 = ashr exact i64 %2, 32
  %4 = getelementptr [16 x %struct.RefCntBuffer.3232263], ptr %0, i64 0, i64 %3, i32 17, i32 9
  ret ptr %4
}
