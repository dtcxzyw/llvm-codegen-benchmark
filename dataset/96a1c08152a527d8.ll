...
entry:
  ...
  %5 = getelementptr nusw [4 x %struct.stbi__huffman.3399138], ptr %0, i64 0, i64 %1
...
entry:
  %3 = lshr i32 %2, 5
  %4 = zext nneg i32 %3 to i64
  %5 = getelementptr [3 x %struct.snd_mask.3536596], ptr %0, i64 0, i64 %1
...
entry:
  %3 = lshr i32 %2, 3
  %4 = zext nneg i32 %3 to i64
  %5 = getelementptr nusw nuw [13 x %"struct.icu_75::Regex8BitSet.3716704"], ptr %0, i64 0, i64 %1
