...
%"class.ue2::bitfield.2245772" = type { %"struct.std::array.2245773" }
%"struct.std::array.2245773" = type { [4 x i64] }
...
entry:
  ...
  %4 = getelementptr inbounds %"struct.ue2::(anonymous namespace)::LookProto.2245821", ptr %1, i64 %3
  %5 = ptrtoint ptr %4 to i64
  %6 = ptrtoint ptr %0 to i64
  %7 = sub i64 %6, %5
  ret i64 %7
