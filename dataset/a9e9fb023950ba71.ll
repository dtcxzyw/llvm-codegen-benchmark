...
entry:
  ...
  %5 = getelementptr nusw %"struct.re2::Splice.2486349", ptr %0, i64 %4
  ret ptr %5
}
...
entry:
  ...
  %5 = getelementptr nusw nuw %"class.QuantLib::Date.2718310", ptr %0, i64 %4
  ret ptr %5
}
...
entry:
  %3 = call i64 @llvm.umin.i64(i64 %2, i64 1152921504606846975)
  %4 = select i1 %1, i64 1152921504606846975, i64 %3
  %5 = getelementptr %"struct.std::pair.3258423", ptr %0, i64 %4
  ret ptr %5
}
