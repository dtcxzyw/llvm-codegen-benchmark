...
entry:
  %3 = lshr i64 %2, 1
  %4 = tail call noundef range(i64 0, 4611686018427387904) i64 @llvm.umin.i64(i64 range(i64 0, 4611686018427387904) %3, i64 range(i64 0, -1) %1)
  %5 = icmp ult i64 %0, %4
  ret i1 %5
}
...
entry:
  %3 = lshr i64 %2, 1
  %4 = tail call i64 @llvm.umin.i64(i64 range(i64 0, -9223372036854775808) %1, i64 %3)
  %5 = icmp ult i64 %0, %4
  ret i1 %5
}
