...
entry:
  ...
  %3 = getelementptr nusw %"struct.rocksdb::TableReader::Anchor.2504818", ptr %1, i64 %.neg
...
entry:
  %.neg = sdiv exact i64 %2, -40
  %3 = getelementptr %"struct.mold::elf::DynamicPattern.2525528", ptr %1, i64 %.neg
  %4 = ptrtoint ptr %3 to i64
  %5 = sub i64 %4, %0
  ret i64 %5
}
...
entry:
  %.neg = sdiv i64 %2, -2
  %3 = getelementptr nusw ptr, ptr %1, i64 %.neg
  %4 = ptrtoint ptr %3 to i64
  %5 = sub i64 %4, %0
  ret i64 %5
}
