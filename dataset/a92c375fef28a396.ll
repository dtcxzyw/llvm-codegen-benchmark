...
entry:
  ...
  %5 = getelementptr inbounds %struct.dt_iop_tonecurve_node_t.1767712, ptr %4, i64 %3, i32 1
  ret ptr %5
}
...
entry:
  ...
  %5 = getelementptr %"struct.BSplineEvaluationData<2, BOUNDARY_NEUMANN>::BSplineComponents.2210405", ptr %4, i64 %3, i32 0, i64 0, i32 0, i64 1
  ret ptr %5
}
