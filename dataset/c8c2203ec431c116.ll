...
entry:
  ...
  %4 = getelementptr nusw nuw [32 x %"struct.std::pair.340.2970149"], ptr %0, i64 0, i64 %3
...
entry:
  %2 = shl nuw nsw i64 %1, 1
  %3 = or disjoint i64 %2, 1
  %4 = getelementptr [512 x %struct.prefix_code_symbol.3436864], ptr %0, i64 0, i64 %3, i32 1
  ret ptr %4
}
