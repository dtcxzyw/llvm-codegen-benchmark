...
entry:
  %3 = xor i64 %2, -1
  %4 = and i64 %3, %1
  %5 = getelementptr inbounds %"struct.rocksdb::ConcurrentArena::Shard.1578609", ptr %0, i64 %4, i32 1
  ret ptr %5
}
...
entry:
  %3 = xor i64 %2, -1
  %4 = and i64 %3, %1
  %5 = getelementptr %struct.ZSTD_seqSymbol.2017025, ptr %0, i64 %4, i32 3
  ret ptr %5
}
