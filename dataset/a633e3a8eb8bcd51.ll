...
entry:
  %3 = add nsw i32 %1, %2
  %4 = sext i32 %3 to i64
  %5 = getelementptr [256 x %struct.MinimapPixel.2586185], ptr %0, i64 0, i64 %4, i32 2
  ret ptr %5
}
...
entry:
  %3 = add nsw i32 %1, %2
  %4 = sext i32 %3 to i64
  %5 = getelementptr [64 x %"struct.open_spiel::chess::Piece.3288780"], ptr %0, i64 0, i64 %4, i32 1
  ret ptr %5
}
