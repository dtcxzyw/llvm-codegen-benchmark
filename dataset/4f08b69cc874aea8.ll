...
entry:
  %2 = sub nsw i32 1, %1
  %3 = sext i32 %2 to i64
  %4 = getelementptr [2 x %struct.list_head.3243648], ptr %0, i64 0, i64 %3, i32 1
  ret ptr %4
}
...
entry:
  %2 = sub i32 0, %1
  %3 = sext i32 %2 to i64
  %4 = getelementptr [3 x %struct.dlist_head.3467827], ptr %0, i64 0, i64 %3, i32 0, i32 1
  ret ptr %4
}
...
entry:
  %2 = sub nsw i32 1, %1
  %3 = sext i32 %2 to i64
  %4 = getelementptr [2 x %"class.std::vector.2.3618791"], ptr %0, i64 0, i64 %3, i32 0, i32 0, i32 0, i32 1
  ret ptr %4
}
