...
%"class.opencc::UTF8StringSliceBase.2749016" = type <{ ptr, i8, i8, [6 x i8] }>
%struct.cdf_directory_t.2789304 = type { [32 x i16], i16, i8, i8, i32, i32, i32, [2 x i64], i32, i64, i64, i32, i32, i32 }
...
entry:
  %3 = lshr i64 %2, 1
  %4 = mul i64 %1, %3
  %5 = getelementptr nusw nuw %"class.opencc::UTF8StringSliceBase.2749016", ptr %0, i64 %4
  ret ptr %5
}
...
entry:
  %3 = lshr i64 %2, 7
  %4 = mul i64 %1, %3
  %5 = getelementptr %struct.cdf_directory_t.2789304, ptr %0, i64 %4
  ret ptr %5
}
