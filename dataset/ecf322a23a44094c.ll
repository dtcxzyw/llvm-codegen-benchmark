...
define ptr @func000000000000007a(i64 %0, i32 %1) #0 {
entry:
...
entry:
  ...
  %6 = getelementptr nusw [12 x %"class.llvm::SlotIndex.2949619"], ptr %5, i64 0, i64 %3
  ret ptr %6
}
...
; Function Attrs: nounwind
define ptr @func0000000000000078(i64 %0, i32 %1) #0 {
entry:
  %2 = add nuw nsw i32 %1, 1
  %3 = zext nneg i32 %2 to i64
  %4 = inttoptr i64 %0 to ptr
...
; quickjs/optimized/quickjs.ll
; Function Attrs: nounwind
define ptr @func0000000000000038(i64 %0, i32 %1) #0 {
entry:
  %2 = add nsw i32 %1, -1
  %3 = zext nneg i32 %2 to i64
  %4 = inttoptr i64 %0 to ptr
