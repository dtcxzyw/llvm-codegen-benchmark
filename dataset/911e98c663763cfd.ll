...
entry:
  ...
  %5 = getelementptr [6 x %"struct.asmjit::_abi_1_10::OpRWInfo.2493397"], ptr %4, i64 0, i64 %3, i32 2
  ret ptr %5
}
...
entry:
  ...
  %5 = getelementptr [15 x %"union.std::aligned_storage<16, 8>::type.2688022"], ptr %4, i64 0, i64 %3, i32 0, i64 8
  ret ptr %5
}
...
entry:
  ...
  %3 = zext nneg i32 %2 to i64
  %4 = getelementptr nusw nuw i8, ptr %0, i64 2392
  %5 = getelementptr [5 x %"class.llvm::FunctionCallee.2962093"], ptr %4, i64 0, i64 %3, i32 1
  ret ptr %5
}
