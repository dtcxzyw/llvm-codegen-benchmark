...
entry:
  %2 = fsub double %0, %1
  %3 = tail call double @llvm.fabs.f64(double %2)
  %4 = fcmp uge double %3, 0x3EF0001000100010
  ret i1 %4
}
...
entry:
  ...
  %4 = fcmp ugt double %3, 0x3C9CD2B297D889BC
  ret i1 %4
}
...
entry:
  %2 = fsub double %0, %1
  %3 = call double @llvm.fabs.f64(double %2)
  %4 = fcmp ole double %3, 0x3C9CD2B297D889BC
  ret i1 %4
}
...
entry:
  %2 = fsub double %0, %1
  %3 = tail call noundef double @llvm.fabs.f64(double %2)
  %4 = fcmp oeq double %3, 0x400921FB54442D18
  ret i1 %4
}
...
entry:
  %2 = fsub double %0, %1
  %3 = tail call double @llvm.fabs.f64(double %2)
  %4 = fcmp oge double %3, 1.000000e-10
  ret i1 %4
}
