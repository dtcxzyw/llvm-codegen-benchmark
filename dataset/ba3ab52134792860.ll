...
entry:
  %3 = zext i32 %2 to i64
  %4 = getelementptr [6 x %"class.std::map.2798628"], ptr %1, i64 0, i64 %3, i32 0, i32 0, i32 1
  %5 = icmp eq ptr %4, %0
  ret i1 %5
}
...
entry:
  ...
  %4 = getelementptr [11 x %struct.free_area.3357063], ptr %1, i64 0, i64 %3, i32 0, i64 1
  %5 = icmp eq ptr %4, %0
  ret i1 %5
}
...
entry:
  %3 = zext nneg i32 %2 to i64
  %4 = getelementptr [31 x %struct.xhci_virt_ep.3361081], ptr %1, i64 0, i64 %3, i32 7
  %5 = icmp eq ptr %4, %0
  ret i1 %5
}
...
entry:
  %3 = zext i32 %2 to i64
  %4 = getelementptr [4 x %struct.sbq_wait.3372303], ptr %1, i64 0, i64 %3, i32 1, i32 3
  %5 = icmp eq ptr %4, %0
  ret i1 %5
}
...
entry:
  %3 = zext nneg i32 %2 to i64
  %4 = getelementptr [4 x %"class.std::map.3384341"], ptr %1, i64 0, i64 %3, i32 0, i32 0, i32 1
  %5 = icmp eq ptr %4, %0
  ret i1 %5
}
