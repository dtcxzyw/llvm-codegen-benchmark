...
%"class.std::vector.157.2720273" = type { %"struct.std::_Vector_base.158.2720274" }
%"struct.std::_Vector_base.158.2720274" = type { %"struct.std::_Vector_base<boost::shared_ptr<QuantLib::SmileSection>, std::allocator<boost::shared_ptr<QuantLib::SmileSection>>>::_Vector_impl.2720275" }
%"struct.std::_Vector_base<boost::shared_ptr<QuantLib::SmileSection>, std::allocator<boost::shared_ptr<QuantLib::SmileSection>>>::_Vector_impl.2720275" = type { %"struct.std::_Vector_base<boost::shared_ptr<QuantLib::SmileSection>, std::allocator<boost::shared_ptr<QuantLib::SmileSection>>>::_Vector_impl_data.2720276" }
%"struct.std::_Vector_base<boost::shared_ptr<QuantLib::SmileSection>, std::allocator<boost::shared_ptr<QuantLib::SmileSection>>>::_Vector_impl_data.2720276" = type { ptr, ptr, ptr }
...
entry:
  ...
  %5 = tail call i64 @llvm.umin.i64(i64 %1, i64 384307168202282325)
  %6 = select i1 %4, i64 384307168202282325, i64 %5
  %7 = getelementptr nusw nuw %"class.std::vector.157.2720273", ptr %0, i64 %6
  ret ptr %7
}
