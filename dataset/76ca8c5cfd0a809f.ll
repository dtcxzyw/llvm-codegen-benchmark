...
entry:
  ...
  %5 = getelementptr nusw %"struct.rocksdb::TableReader::Anchor.2504818", ptr %0, i64 %.neg
  ret ptr %5
}
...
entry:
  ...
  %4 = sub i64 %1, %3
  %.neg = sdiv exact i64 %4, -40
  %5 = getelementptr %"struct.mold::elf::DynamicPattern.2525528", ptr %0, i64 %.neg
  ret ptr %5
}
...
entry:
  ...
  %5 = getelementptr %"class.irr::core::vector3d.2577639", ptr %0, i64 %.neg
