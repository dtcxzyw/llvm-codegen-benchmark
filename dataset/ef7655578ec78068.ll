...
entry:
  ...
  %5 = sext i32 %0 to i64
  %6 = getelementptr [0 x %struct.vfio_region_sparse_mmap_area.2593911], ptr %4, i64 0, i64 %5
  ret ptr %6
}
...
entry:
  ...
  %5 = sext i32 %0 to i64
  %6 = getelementptr nusw [5 x %struct.anon.2596889], ptr %4, i64 0, i64 %5
  ret ptr %6
}
...
entry:
  %3 = sext i32 %0 to i64
  %4 = getelementptr %"struct.OpenSubdiv::v3_6_0::Bfr::PatchTree::TreeNode.3210405", ptr %1, i64 %2, i32 1, i64 %3
  ret ptr %4
}
