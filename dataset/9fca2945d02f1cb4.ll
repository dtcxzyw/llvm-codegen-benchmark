...
entry:
  ...
  %4 = sub nsw i64 0, %3
  %5 = getelementptr nusw %"class.llvm::Use.3138384", ptr %0, i64 %4
...
entry:
  %3 = zext nneg i32 %2 to i64
  %4 = sub nsw i64 0, %3
  %5 = getelementptr nusw %"class.llvm::Use.3188703", ptr %0, i64 %4
  %6 = getelementptr nusw i8, ptr %1, i64 -32
  %7 = icmp ne ptr %5, %6
  ret i1 %7
}
...
entry:
  %3 = zext nneg i32 %2 to i64
  %4 = sub nsw i64 0, %3
  %5 = getelementptr nusw %"class.std::__cxx11::basic_string.3864248", ptr %0, i64 %4
