...
%struct.ImGuiTabItem.3263851 = type <{ i32, i32, i32, i32, float, float, float, float, i32, i16, i16, i8, [3 x i8] }>
...
entry:
  ...
  %4 = add nsw i32 %3, %1
  %5 = zext i32 %4 to i64
  %6 = getelementptr %struct.hb_glyph_position_t.2623494, ptr %0, i64 %5, i32 2
  ret ptr %6
}
...
entry:
  ...
  %7 = getelementptr nusw i8, ptr %6, i64 147
  ret ptr %7
}
...
entry:
  ...
  %6 = getelementptr %struct.ImGuiTabItem.3263851, ptr %0, i64 %5, i32 1
  ret ptr %6
}
