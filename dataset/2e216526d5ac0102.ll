...
entry:
  ...
  %3 = lshr i64 %2, 1
  %4 = getelementptr %"struct.std::__1::pair.61.2494200", ptr %0, i64 %3, i32 1
  ret ptr %4
}
...
entry:
  %2 = ashr exact i64 %1, 5
  %3 = lshr i64 %2, 1
  %4 = getelementptr %"struct.cv::SimpleBlobDetectorImpl::Center.3605727", ptr %0, i64 %3, i32 0, i32 1
  ret ptr %4
}
