...
%struct.power_supply_vbat_ri_table.3368696 = type { i32, i32 }
%struct.bio_vec.3369314 = type { ptr, i32, i32 }
...
entry:
  ...
  %4 = add nsw i32 %3, %1
  %5 = sext i32 %4 to i64
  %6 = getelementptr %struct._zend_ssa_op.2681950, ptr %0, i64 %5
...
entry:
  ...
  %4 = add nsw i32 %3, %1
  %5 = sext i32 %4 to i64
  %6 = getelementptr %struct.power_supply_vbat_ri_table.3368696, ptr %0, i64 %5, i32 1
  ret ptr %6
}
...
entry:
  ...
  %4 = add i32 %3, %1
  %5 = sext i32 %4 to i64
  %6 = getelementptr %struct.bio_vec.3369314, ptr %0, i64 %5, i32 1
  ret ptr %6
}
