...
entry:
  %2 = tail call noundef i32 @llvm.smin.i32(i32 %1, i32 20)
  %3 = add nsw i32 %2, %0
  ret i32 %3
}
...
entry:
  %2 = tail call noundef i64 @llvm.smin.i64(i64 %1, i64 4611686018427387903)
  %3 = add i64 %2, %0
  ret i64 %3
}
...
entry:
  %2 = tail call i64 @llvm.smin.i64(i64 %1, i64 192)
