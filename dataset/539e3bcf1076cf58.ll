...
entry:
  %1 = tail call float @llvm.fmuladd.f32(float %0, float 0xBEF3B04360000000, float 0x3F3EEE46C0000000)
...
entry:
  %1 = tail call noundef float @llvm.fmuladd.f32(float %0, float 0xBE52A32500000000, float 0xBF0BFF7260000000)
