...
%struct.zone.2005611 = type { [4 x i64], i64, i64, [4 x i64], i32, ptr, ptr, ptr, i32, i32, i32, i64, %struct.atomic64_t.2005603, i64, i64, ptr, i32, [20 x i8], %struct.cacheline_padding.2005612, [11 x %struct.free_area.2005613], i64, %struct.spinlock.2005614, [28 x i8], %struct.cacheline_padding.2005612, i64, i64, [2 x i64], i64, i64, i32, i32, i32, i8, i8, [2 x i8], %struct.cacheline_padding.2005612, [10 x %struct.atomic64_t.2005603], [6 x %struct.atomic64_t.2005603] }
%struct.atomic64_t.2005603 = type { i64 }
%struct.free_area.2005613 = type { [4 x %struct.list_head.2005586], i64 }
%struct.list_head.2005586 = type { ptr, ptr }
%struct.spinlock.2005614 = type { %union.anon.23.2005615 }
%union.anon.23.2005615 = type { %struct.raw_spinlock.2005604 }
%struct.raw_spinlock.2005604 = type { %struct.qspinlock.2005606 }
%struct.qspinlock.2005606 = type { %union.anon.24.2005607 }
%union.anon.24.2005607 = type { %struct.atomic_t.2005580 }
%struct.atomic_t.2005580 = type { i32 }
%struct.cacheline_padding.2005612 = type { [0 x i8] }
...
entry:
  ...
  %4 = getelementptr inbounds i8, ptr %0, i64 8
  %5 = getelementptr inbounds [10 x ptr], ptr %4, i64 0, i64 %3
  ret ptr %5
}
...
entry:
  ...
  %5 = getelementptr [15 x %struct.OHCIPort.1661921], ptr %4, i64 0, i64 %3
  ret ptr %5
}
...
entry:
  ...
  %5 = getelementptr [4 x %struct.zone.2005611], ptr %4, i64 0, i64 %3
  ret ptr %5
}
