...
entry:
  %3 = icmp uge i32 %1, %2
  %4 = zext i1 %3 to i64
  %5 = getelementptr nuw [2 x %"class.llvm::APInt.3287037"], ptr %0, i64 0, i64 %4, i32 1
  ret ptr %5
}
...
entry:
  %3 = icmp ne i32 %1, %2
  %4 = zext i1 %3 to i64
  %5 = getelementptr [2 x %struct.ssh_peer_data.3453360], ptr %0, i64 0, i64 %4, i32 1
  ret ptr %5
}
...
entry:
  %3 = icmp ne i32 %1, %2
  %4 = zext i1 %3 to i64
  %5 = getelementptr [2 x %struct.ssh_peer_data.3453360], ptr %0, i64 0, i64 %4, i32 10, i64 1
  ret ptr %5
}
