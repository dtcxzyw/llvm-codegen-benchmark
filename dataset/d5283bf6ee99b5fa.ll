...
%struct.FormData_pg_attribute.3467018 = type { i32, %struct.nameData.3467019, i32, i16, i16, i32, i32, i16, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i16, i32 }
%struct.nameData.3467019 = type { [64 x i8] }
...
entry:
  %2 = sext i16 %1 to i64
  %3 = add nsw i64 %2, -1
  %4 = getelementptr nusw [99 x %struct.nk_text_undo_record.2869489], ptr %0, i64 0, i64 %3
  ret ptr %4
}
...
entry:
  %2 = sext i16 %1 to i64
  %3 = add nsw i64 %2, -1
  %4 = getelementptr [0 x %struct.FormData_pg_attribute.3467018], ptr %0, i64 0, i64 %3
  ret ptr %4
}
