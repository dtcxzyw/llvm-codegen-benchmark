...
entry:
  ...
  %4 = getelementptr %struct.AHCIDevice.2595507, ptr %0, i64 %3, i32 5, i32 14
  ret ptr %4
}
...
entry:
  %2 = shl i64 %1, 32
  %3 = ashr exact i64 %2, 32
  %4 = getelementptr %"struct.ozz::animation::offline::RawAnimation::JointTrack.3471687", ptr %0, i64 %3, i32 2, i32 0, i32 0, i32 0, i32 1
  ret ptr %4
}
