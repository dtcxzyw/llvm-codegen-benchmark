...
entry:
  %3 = tail call range(i16 0, 17) i16 @llvm.cttz.i16(i16 %2, i1 false)
  %4 = zext nneg i16 %3 to i64
...
; Function Attrs: nounwind
define ptr @func00000000000000db(ptr %0, i64 %1, i16 %2) #0 {
entry:
  %3 = tail call range(i16 0, 17) i16 @llvm.cttz.i16(i16 %2, i1 true)
  %4 = zext nneg i16 %3 to i64
...
; hyperscan/optimized/mpv.c.ll
; Function Attrs: nounwind
define ptr @func000000000000009b(ptr %0, i64 %1, i16 %2) #0 {
entry:
  %3 = tail call range(i16 0, 17) i16 @llvm.cttz.i16(i16 %2, i1 true)
  %4 = zext nneg i16 %3 to i64
  %5 = getelementptr i8, ptr %0, i64 %1
