...
entry:
  ...
  %2 = getelementptr nusw %"struct.rocksdb::TableReader::Anchor.2504818", ptr %0, i64 %.neg
  ret ptr %2
}
...
entry:
  %.neg = sdiv exact i64 %1, -40
  %2 = getelementptr %"struct.mold::elf::DynamicPattern.2525528", ptr %0, i64 %.neg
  ret ptr %2
}
...
entry:
  ...
  %2 = getelementptr %"class.irr::core::vector3d.2577639", ptr %0, i64 %.neg
...
entry:
  %.neg = sdiv i64 %1, -2
  %2 = getelementptr nusw %struct.GC_ms_entry.2591444, ptr %0, i64 %.neg
  ret ptr %2
}
