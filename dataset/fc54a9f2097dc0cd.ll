...
entry:
  %3 = sext i32 %2 to i64
  %4 = getelementptr inbounds [128 x %struct.NSVGattrib.1553121], ptr %1, i64 0, i64 %3, i32 11, i64 %0
  ret ptr %4
}
...
entry:
  %3 = sext i32 %2 to i64
  %4 = getelementptr [64 x %struct.XHCISlot.1662560], ptr %1, i64 0, i64 %3, i32 5, i64 %0
  ret ptr %4
}
