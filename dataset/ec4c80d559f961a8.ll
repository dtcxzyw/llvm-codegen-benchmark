...
%"struct.TristateVisitor::RefStrength.1687340" = type <{ ptr, %class.VStrength.1687291, [7 x i8] }>
%class.VStrength.1687291 = type { i8 }
...
entry:
  ...
  %3 = add nsw i64 %2, -2
  %4 = lshr i64 %3, 1
  %5 = getelementptr inbounds %"struct.TristateVisitor::RefStrength.1687340", ptr %0, i64 %4
  ret ptr %5
}
