...
entry:
  %3 = zext i32 %2 to i64
  %4 = icmp ugt i64 %0, %3
  %5 = getelementptr nusw nuw %"class.WasmEdge::AST::TagType.2774110", ptr %1, i64 %3
...
entry:
  ...
  %4 = icmp ugt i64 %0, %3
  %5 = getelementptr nusw nuw %"struct.open_spiel::algorithms::FSICFRNode.3491588", ptr %1, i64 %3
  %6 = select i1 %4, ptr %5, ptr null
  ret ptr %6
}
