...
entry:
  ...
  %5 = getelementptr nusw [1 x i32], ptr %4, i64 0, i64 %3
  ret ptr %5
}
...
entry:
  ...
  %3 = zext nneg i32 %2 to i64
  %4 = getelementptr nusw i8, ptr %0, i64 29384
...
entry:
  ...
  %5 = getelementptr nusw [5 x %"class.llvm::FunctionCallee.2962093"], ptr %4, i64 0, i64 %3
  ret ptr %5
}
...
entry:
  ...
  %3 = zext nneg i32 %2 to i64
  %4 = getelementptr nusw nuw i8, ptr %0, i64 260
...
entry:
  %2 = tail call range(i32 1, 33) i32 @llvm.cttz.i32(i32 %1, i1 true)
  %3 = zext nneg i32 %2 to i64
  %4 = getelementptr nusw i8, ptr %0, i64 584
  %5 = getelementptr nusw [32 x ptr], ptr %4, i64 0, i64 %3
  ret ptr %5
}
