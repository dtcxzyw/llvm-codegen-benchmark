...
%"struct.(anonymous namespace)::FormatKeys.2684357" = type { %"class.folly::Range.2684358", i64, i64 }
%"class.folly::Range.2684358" = type { ptr, ptr }
%struct.BuiltinEntry.3205476 = type { i32, i32 }
...
entry:
  %3 = lshr i64 %2, 1
  %4 = getelementptr nusw nuw %"struct.(anonymous namespace)::FormatKeys.2684357", ptr %1, i64 %3
...
entry:
  %3 = lshr i64 %2, 1
  %4 = getelementptr nusw nuw %struct.BuiltinEntry.3205476, ptr %1, i64 %3
  %5 = getelementptr nusw nuw i8, ptr %4, i64 8
  %6 = select i1 %0, ptr %5, ptr %1
