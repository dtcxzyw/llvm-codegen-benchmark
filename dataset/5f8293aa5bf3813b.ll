...
%"class.cvc5::internal::theory::eq::EqualityEngine::EqualityEdge.3379410" = type { i32, i32, i32, %"class.cvc5::internal::NodeTemplate.223.3379398" }
%"class.cvc5::internal::NodeTemplate.223.3379398" = type { ptr }
...
entry:
  %2 = or disjoint i64 %1, 1
  %3 = getelementptr %"class.std::__1::tuple.2488118", ptr %0, i64 %2, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 1
  ret ptr %3
}
...
entry:
  %2 = or disjoint i64 %1, 1
  %3 = getelementptr %"class.std::__cxx11::basic_string.2509008", ptr %0, i64 %2
...
entry:
  %2 = or disjoint i64 %1, 1
  %3 = getelementptr %"class.boost::shared_ptr.29.2718975", ptr %0, i64 %2, i32 1
  ret ptr %3
}
...
entry:
  %2 = or disjoint i64 %1, 1
  %3 = getelementptr %"struct.QuantLib::MarketModelMultiProduct::CashFlow.2735437", ptr %0, i64 %2, i32 1
  ret ptr %3
}
...
entry:
  %2 = or i64 %1, 1
  %3 = getelementptr %"class.cvc5::internal::theory::eq::EqualityEngine::EqualityEdge.3379410", ptr %0, i64 %2, i32 1
  ret ptr %3
}
