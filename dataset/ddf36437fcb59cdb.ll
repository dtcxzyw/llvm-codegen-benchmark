...
%"class.QuantLib::Date.2723567" = type { i64 }
...
entry:
  %2 = sext i32 %1 to i64
  %3 = getelementptr %"struct.ncnn::custom_layer_registry_entry.2636478", ptr %0, i64 %2
...
entry:
  %2 = sext i32 %1 to i64
  %3 = getelementptr %"class.std::vector.0.2721086", ptr %0, i64 %2
...
entry:
  %2 = add i32 %1, -1
  %3 = sext i32 %2 to i64
  %4 = getelementptr nusw nuw %"class.QuantLib::Date.2723567", ptr %0, i64 %3
  ret ptr %4
}
