...
%"union.absl::debian2::container_internal::map_slot_type.2486281" = type { i64, [8 x i8] }
...
entry:
  %3 = getelementptr nusw %"union.absl::debian2::container_internal::map_slot_type.2486281", ptr %1, i64 %2
...
; Function Attrs: nounwind
define { ptr, ptr } @func0000000000000000(ptr %0, ptr %1, i64 %2) #0 {
entry:
