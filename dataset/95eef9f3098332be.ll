...
entry:
  ...
  %3 = getelementptr nusw nuw [1 x %struct.NSVGgradientStop.2600676], ptr %0, i64 0, i64 %2
  ret ptr %3
}
...
entry:
  %2 = add nsw i64 %1, -1
  %3 = getelementptr nusw nuw [11 x i8], ptr %0, i64 0, i64 %2
  ret ptr %3
}
...
entry:
  %2 = add i64 %1, 1
  %3 = getelementptr nusw [32 x %"struct.rocksdb::FilePickerMultiGet::FilePickerContext.2615560"], ptr %0, i64 0, i64 %2
  ret ptr %3
}
