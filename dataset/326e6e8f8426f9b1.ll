...
%struct._zend_jit_reg_var.2681852 = type { i32, i32 }
...
entry:
  %2 = shl i64 %1, 25
  %3 = ashr i64 %2, 32
  %4 = getelementptr %struct.AHCIDevice.2595507, ptr %0, i64 %3, i32 12
  ret ptr %4
}
...
entry:
  %2 = shl i64 %1, 30
  %3 = ashr i64 %2, 32
  %4 = getelementptr %struct._zend_jit_reg_var.2681852, ptr %0, i64 %3, i32 1
  ret ptr %4
}
