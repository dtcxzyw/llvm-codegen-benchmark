...
entry:
  ...
  %6 = getelementptr inbounds %"class.Ipopt::TripletToCSRConverter::TripletEntry.1564267", ptr %5, i64 %4
  ret ptr %6
}
...
entry:
  ...
  %6 = getelementptr %"class.std::vector.112.1747357", ptr %5, i64 %4
  ret ptr %6
}
...
entry:
  ...
  %5 = getelementptr i8, ptr %0, i64 8
  %6 = getelementptr inbounds %"class.std::vector.45.1753024", ptr %5, i64 %4
  ret ptr %6
}
