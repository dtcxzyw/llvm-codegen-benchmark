...
%struct.FormData_pg_attribute.3653608 = type { i32, %struct.nameData.3653609, i32, i16, i16, i32, i32, i16, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i8, i16, i32 }
%struct.nameData.3653609 = type { [64 x i8] }
...
entry:
  ...
  %4 = getelementptr [5 x %struct.rb_size_pool_struct.2601024], ptr %3, i64 0, i64 %1
  %5 = icmp eq ptr %4, %0
  ret i1 %5
}
...
entry:
  ...
  %4 = getelementptr nusw nuw [16 x %class.XMarkStripe.2733578], ptr %3, i64 0, i64 %1
  %5 = icmp eq ptr %4, %0
  ret i1 %5
}
...
entry:
  ...
  %4 = getelementptr nusw nuw [16 x %class.ZMarkStripe.2737375], ptr %3, i64 0, i64 %1
  %5 = icmp ne ptr %4, %0
  ret i1 %5
}
...
entry:
  ...
  %4 = getelementptr nusw [3058 x %"class.facebook::velox::CompactDoubleList.2799404"], ptr %3, i64 0, i64 %1
  %5 = icmp eq ptr %4, %0
  ret i1 %5
}
...
entry:
  ...
  %4 = getelementptr [0 x %struct.FormData_pg_attribute.3653608], ptr %3, i64 0, i64 %1
  %5 = icmp ult ptr %4, %0
  ret i1 %5
}
