...
entry:
  %2 = tail call noundef i32 @llvm.fshl.i32(i32 %1, i32 %1, i32 6)
  %3 = sub i32 %0, %1
  %4 = xor i32 %3, %2
  %5 = tail call noundef i32 @llvm.fshl.i32(i32 %4, i32 %4, i32 8)
  ret i32 %5
}
...
entry:
  %2 = tail call i32 @llvm.fshl.i32(i32 %1, i32 %1, i32 4)
  %3 = sub i32 %0, %1
  %4 = xor i32 %3, %2
