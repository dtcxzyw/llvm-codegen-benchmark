...
%union.Node.3532601 = type { %struct.NodeKey.3532602 }
%struct.NodeKey.3532602 = type { %union.Value.3532603, i8, i8, i32, %union.Value.3532603 }
%union.Value.3532603 = type { ptr }
...
entry:
  ...
  %3 = shl nuw i32 1, %2
  %4 = sext i32 %3 to i64
  %5 = getelementptr nusw %union.Node.3532601, ptr %0, i64 %4
  ret ptr %5
}
