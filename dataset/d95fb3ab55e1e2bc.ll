...
%"class.std::vector.65.2720473" = type { %"struct.std::_Vector_base.66.2720474" }
%"struct.std::_Vector_base.66.2720474" = type { %"struct.std::_Vector_base<QuantLib::MarketModelMultiProduct::CashFlow, std::allocator<QuantLib::MarketModelMultiProduct::CashFlow>>::_Vector_impl.2720475" }
%"struct.std::_Vector_base<QuantLib::MarketModelMultiProduct::CashFlow, std::allocator<QuantLib::MarketModelMultiProduct::CashFlow>>::_Vector_impl.2720475" = type { %"struct.std::_Vector_base<QuantLib::MarketModelMultiProduct::CashFlow, std::allocator<QuantLib::MarketModelMultiProduct::CashFlow>>::_Vector_impl_data.2720476" }
%"struct.std::_Vector_base<QuantLib::MarketModelMultiProduct::CashFlow, std::allocator<QuantLib::MarketModelMultiProduct::CashFlow>>::_Vector_impl_data.2720476" = type { ptr, ptr, ptr }
...
entry:
  ...
  %6 = getelementptr nusw %"struct.re2::PrefilterTree::Entry.2486658", ptr %0, i64 %5
  ret ptr %6
}
...
entry:
  ...
  %6 = getelementptr nusw nuw %"class.std::vector.65.2720473", ptr %0, i64 %5
  ret ptr %6
}
