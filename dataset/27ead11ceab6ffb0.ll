...
entry:
  ...
  %4 = getelementptr nusw nuw [15 x %"union.std::aligned_storage<16, 8>::type.2686269"], ptr %1, i64 0, i64 %3
...
entry:
  %3 = zext i32 %2 to i64
  %4 = getelementptr [8 x %struct.skl_plane_wm.3534276], ptr %1, i64 0, i64 %3, i32 1
...
entry:
  %3 = zext nneg i32 %2 to i64
  %4 = getelementptr nusw nuw [2 x %struct.AF_CJKAxisRec_.3881763], ptr %1, i64 0, i64 %3
  %5 = getelementptr nusw nuw i8, ptr %4, i64 432
  %6 = getelementptr nusw nuw %struct.AF_CJKBlueRec_.3881743, ptr %5, i64 %0
  ret ptr %6
}
