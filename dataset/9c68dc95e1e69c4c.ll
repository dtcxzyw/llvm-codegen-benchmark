...
%struct.lua_TValue.2127376 = type { %union.Value.2127377, i32 }
%union.Value.2127377 = type { ptr }
...
entry:
  ...
  %5 = getelementptr inbounds [16 x i8], ptr %4, i64 0, i64 %3
  ret ptr %5
}
...
entry:
  ...
  %5 = getelementptr inbounds [10 x i64], ptr %4, i64 0, i64 %3
  ret ptr %5
}
...
entry:
  %2 = sub nuw nsw i32 -10003, %1
  %3 = zext nneg i32 %2 to i64
  %4 = getelementptr inbounds i8, ptr %0, i64 40
  %5 = getelementptr inbounds [1 x %struct.lua_TValue.2127376], ptr %4, i64 0, i64 %3
  ret ptr %5
}
