...
%"struct.std::atomic.405.1590019" = type { %"struct.std::__atomic_base.406.1590022" }
%"struct.std::__atomic_base.406.1590022" = type { ptr }
%"struct.std::atomic.614.1593128" = type { %"struct.std::__atomic_base.615.1593130" }
%"struct.std::__atomic_base.615.1593130" = type { ptr }
...
entry:
  ...
  %3 = xor i64 %2, 63
  %4 = getelementptr inbounds %"struct.std::atomic.405.1590019", ptr %0, i64 %3
  ret ptr %4
}
...
entry:
  ...
  %3 = xor i64 %2, 63
  %4 = getelementptr inbounds %"struct.std::atomic.614.1593128", ptr %0, i64 %3
  ret ptr %4
}
