...
entry:
  ...
  %5 = add nsw i64 %4, -1
  %6 = getelementptr inbounds %"struct.asio::detail::timer_queue<asio::detail::chrono_time_traits<std::chrono::_V2::steady_clock, asio::wait_traits<std::chrono::_V2::steady_clock>>>::heap_entry.1699723", ptr %0, i64 %5, i32 1
  ret ptr %6
}
