...
entry:
  ...
  %5 = getelementptr [11 x %struct.free_area.2009871], ptr %4, i64 0, i64 %3, i32 0, i64 1
  %6 = icmp eq ptr %5, %0
  ret i1 %6
}
...
entry:
  ...
  %5 = getelementptr [31 x %struct.xhci_virt_ep.2014095], ptr %4, i64 0, i64 %3, i32 7
  %6 = icmp eq ptr %5, %0
  ret i1 %6
}
...
entry:
  ...
  %5 = getelementptr [4 x %struct.sbq_wait.2025688], ptr %4, i64 0, i64 %3, i32 1, i32 3
  %6 = icmp eq ptr %5, %0
  ret i1 %6
}
