...
%struct.CType.3498636 = type { i32, i32, i16, i16, %struct.GCRef.3498637 }
%struct.GCRef.3498637 = type { i64 }
...
define i32 @func0000000000000042(ptr %0, ptr %1, i32 %2) #0 {
entry:
  %3 = zext i32 %2 to i64
...
; Function Attrs: nounwind
define i32 @func0000000000000058(ptr %0, ptr %1, i32 %2) #0 {
entry:
  %3 = zext i32 %2 to i64
...
entry:
  %3 = zext nneg i32 %2 to i64
  %4 = getelementptr nusw %struct.CType.3498636, ptr %1, i64 %3
  %5 = icmp eq ptr %4, %0
  %6 = zext i1 %5 to i32
  ret i32 %6
}
