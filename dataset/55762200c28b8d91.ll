...
; Function Attrs: nounwind
define ptr @func000000000000004c(i32 %0, ptr %1, i64 %2) #0 {
entry:
...
; wasmtime-rs/optimized/1f0cdl9sv7ergjr2.ll
; Function Attrs: nounwind
define ptr @func000000000000006c(i32 %0, ptr %1, i64 %2) #0 {
entry:
  %3 = getelementptr nusw nuw [0 x i32], ptr %1, i64 0, i64 %2
  %.not = icmp eq i32 %0, 0
  %4 = select i1 %.not, ptr null, ptr %3
  ret ptr %4
}
...
entry:
  %3 = getelementptr nusw nuw [0 x { { ptr, i64 }, { i32, i32 } }], ptr %1, i64 0, i64 %2
  %4 = icmp eq i32 %0, 0
  %5 = select i1 %4, ptr %3, ptr null
  ret ptr %5
}
...
entry:
  %3 = getelementptr [2 x %struct.ata_device.3531564], ptr %1, i64 0, i64 %2
  %4 = icmp eq i32 %0, 9
  %5 = select i1 %4, ptr %3, ptr null
  ret ptr %5
}
