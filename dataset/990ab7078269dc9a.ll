...
%"class.tbb::detail::d1::blocked_range.1590045" = type { i64, i64, i64 }
%"class.tbb::detail::d1::blocked_range.1591647" = type { i64, i64, i64 }
...
entry:
  ...
  %5 = getelementptr %struct.FWCfgEntry.1665626, ptr %0, i64 %4
  ret ptr %5
}
