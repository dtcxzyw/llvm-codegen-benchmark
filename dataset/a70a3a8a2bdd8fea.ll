...
entry:
  ...
  %5 = getelementptr [32 x %struct.anon.14.1554276], ptr %0, i64 0, i64 %4
  ret ptr %5
}
...
entry:
  ...
  %3 = xor i32 %2, 31
  %4 = zext nneg i32 %3 to i64
  %5 = getelementptr inbounds [14 x %"union.std::aligned_storage<8, 8>::type.1638580"], ptr %0, i64 0, i64 %4
  ret ptr %5
}
