...
entry:
  %1 = tail call i64 @llvm.umin.i64(i64 %0, i64 4294967296)
...
entry:
  %1 = tail call noundef i64 @llvm.umin.i64(i64 %0, i64 4294967295)
  %2 = trunc nuw i64 %1 to i32
  ret i32 %2
}
...
entry:
  %1 = call noundef i64 @llvm.umin.i64(i64 %0, i64 2)
  %2 = trunc nuw nsw i64 %1 to i32
  ret i32 %2
}
