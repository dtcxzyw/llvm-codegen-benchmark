...
%"class.llvm::SDUse.3340136" = type { %"class.llvm::SDValue.3340128", ptr, ptr, ptr }
%"class.llvm::SDValue.3340128" = type <{ ptr, i32, [4 x i8] }>
%struct.ext4_ext_path.3555768 = type { i64, i16, i16, ptr, ptr, ptr, ptr }
%struct.SnapShot.3680917 = type { i32, i16, i16, i8, i8, i8, i8 }
...
entry:
  ...
  %3 = add nsw i32 %2, -1
  %4 = zext i32 %3 to i64
  %5 = getelementptr nuw %"class.llvm::MachineOperand.3149279", ptr %0, i64 %4, i32 3
  ret ptr %5
}
...
entry:
  %2 = zext i16 %1 to i64
  %3 = getelementptr %"class.llvm::SDUse.3340136", ptr %0, i64 %2
...
entry:
  ...
  %3 = add nsw i32 %2, -1
  %4 = zext i32 %3 to i64
  %5 = getelementptr %struct.SnapShot.3680917, ptr %0, i64 %4, i32 5
  ret ptr %5
}
