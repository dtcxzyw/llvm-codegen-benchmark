...
entry:
  ...
  %5 = add nsw i64 %1, %2
  %6 = getelementptr [0 x { i64, i64 }], ptr %4, i64 0, i64 %5, i32 1
  ret ptr %6
}
...
; Function Attrs: nounwind
define ptr @func000000000000016f(ptr %0, i64 %1, i64 %2) #0 {
entry:
  %3 = sub nsw i64 0, %1
  %4 = getelementptr nusw { ptr, ptr }, ptr %0, i64 %3
  %5 = add nsw i64 %1, %2
  %6 = getelementptr nuw [0 x { ptr, ptr }], ptr %4, i64 0, i64 %5, i32 1
  ret ptr %6
}
