...
entry:
  %3 = tail call noundef range(i64 0, -9223372036854775804) i64 @llvm.umin.i64(i64 range(i64 4, -9223372036854775804) %1, i64 %2)
  %4 = sub i64 %3, %0
  %5 = icmp ugt i64 %4, 8
  ret i1 %5
}
...
entry:
  %3 = call noundef i64 @llvm.umin.i64(i64 %1, i64 range(i64 1, 0) %2)
  %4 = icmp ne i64 %3, %0
  ret i1 %4
}
...
entry:
  %3 = call noundef i64 @llvm.umin.i64(i64 %1, i64 range(i64 25, 0) %2)
  %4 = sub nuw i64 %3, %0
  %5 = icmp eq i64 %4, 1
  ret i1 %5
}
