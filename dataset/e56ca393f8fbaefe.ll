...
%"struct.clang::DeclaratorChunk.2944620" = type { i32, %"class.clang::SourceLocation.2944537", %"class.clang::SourceLocation.2944537", %"class.clang::ParsedAttributesView.2944534", %union.anon.1655.2944621 }
%"class.clang::SourceLocation.2944537" = type { i32 }
%"class.clang::ParsedAttributesView.2944534" = type { %"class.clang::SourceRange.2944535", %"class.llvm::SmallVector.680.2944536" }
%"class.clang::SourceRange.2944535" = type { %"class.clang::SourceLocation.2944537", %"class.clang::SourceLocation.2944537" }
%"class.llvm::SmallVector.680.2944536" = type { %"class.llvm::SmallVectorImpl.681.2944538", %"struct.llvm::SmallVectorStorage.684.2944539" }
%"class.llvm::SmallVectorImpl.681.2944538" = type { %"class.llvm::SmallVectorTemplateBase.682.2944540" }
%"class.llvm::SmallVectorTemplateBase.682.2944540" = type { %"class.llvm::SmallVectorTemplateCommon.683.2944541" }
%"class.llvm::SmallVectorTemplateCommon.683.2944541" = type { %"class.llvm::SmallVectorBase.2944542" }
%"class.llvm::SmallVectorBase.2944542" = type { ptr, i32, i32 }
%"struct.llvm::SmallVectorStorage.684.2944539" = type { [48 x i8] }
%union.anon.1655.2944621 = type { %"struct.clang::DeclaratorChunk::ArrayTypeInfo.2944622", [72 x i8] }
%"struct.clang::DeclaratorChunk::ArrayTypeInfo.2944622" = type { i8, ptr }
...
entry:
  %2 = getelementptr %"struct.re2::PrefilterTree::Entry.2486658", ptr %0, i64 %1, i32 1, i32 0, i32 0, i32 0, i32 1
  ret ptr %2
}
...
entry:
  %2 = getelementptr %"struct.rocksdb::FdWithKeyRange.2500152", ptr %0, i64 %1, i32 2, i32 1
  ret ptr %2
}
...
entry:
  %2 = getelementptr %struct.QuorumChildRequest.2592011, ptr %0, i64 %1, i32 1, i32 1
  ret ptr %2
}
...
entry:
  %2 = getelementptr %struct.FlatRange.2594763, ptr %0, i64 %1, i32 2, i32 1
  ret ptr %2
}
...
entry:
  %2 = getelementptr %"struct.clang::DeclaratorChunk.2944620", ptr %0, i64 %1, i32 4, i32 1
  ret ptr %2
}
