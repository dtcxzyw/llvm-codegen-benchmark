...
%"struct.std::atomic.265.1593138" = type { %"struct.std::__atomic_base.266.1593139" }
%"struct.std::__atomic_base.266.1593139" = type { ptr }
...
entry:
  ...
  %4 = xor i64 %3, -1
  %5 = and i64 %4, %1
  %6 = getelementptr inbounds %"struct.std::atomic.265.1593138", ptr %0, i64 %5
  ret ptr %6
}
