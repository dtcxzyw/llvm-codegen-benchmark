...
%"struct.bParse::bNameInfo.2817605" = type { ptr, i8, i32, i32 }
...
entry:
  %2 = sext i16 %1 to i64
  %3 = getelementptr %struct.rv_opcode_data.2707181, ptr %0, i64 %2, i32 1
  ret ptr %3
}
...
entry:
  %2 = sext i16 %1 to i64
  %3 = getelementptr nusw %"struct.bParse::bNameInfo.2817605", ptr %0, i64 %2, i32 1
  ret ptr %3
}
...
entry:
  %2 = sext i16 %1 to i64
  %3 = getelementptr nusw nuw %"class.boost::archive::detail::basic_iarchive_impl::cobject_id.3044655", ptr %0, i64 %2, i32 1
  ret ptr %3
}
