...
%struct.lua_TValue.2941991 = type { %union.Value.2941992, [1 x i32], i32 }
%union.Value.2941992 = type { ptr }
...
entry:
  ...
  %4 = getelementptr nusw nuw %struct._zval_struct.2789090, ptr %0, i64 %3
  ret ptr %4
}
...
entry:
  ...
  %4 = zext nneg i32 %3 to i64
  %5 = getelementptr %struct.lua_TValue.2941991, ptr %0, i64 %4
  ret ptr %5
}
