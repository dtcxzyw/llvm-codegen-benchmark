...
entry:
  ...
  %3 = getelementptr nusw nuw [2 x %"struct.boost::geometry::detail::overlay::turn_operation.2974281"], ptr %0, i64 0, i64 %2
  ret ptr %3
}
...
entry:
  %2 = icmp ult i32 %1, 3
  %3 = zext i1 %2 to i64
  %4 = getelementptr [2 x %struct.ip_ct_tcp_state.3554972], ptr %0, i64 0, i64 %3
  ret ptr %4
}
