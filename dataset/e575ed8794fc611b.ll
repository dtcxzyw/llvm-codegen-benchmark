...
entry:
  ...
  %4 = getelementptr inbounds [4 x %struct.ossl_qrl_enc_level_st.1588444], ptr %1, i64 0, i64 %3
...
entry:
  %3 = zext i8 %2 to i64
  %4 = getelementptr inbounds [256 x %"class.duckdb::Node.1806151"], ptr %1, i64 0, i64 %3
  %5 = select i1 %0, ptr %4, ptr null
  ret ptr %5
}
...
entry:
  %3 = zext i32 %2 to i64
  %4 = getelementptr [2 x %struct.ata_device.1994654], ptr %1, i64 0, i64 %3
  %5 = select i1 %0, ptr %4, ptr null
  ret ptr %5
}
