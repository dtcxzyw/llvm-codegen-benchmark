...
%"class.cv::Point_.3569554" = type { float, float }
...
entry:
  ...
  %5 = mul nsw i32 %4, %1
  %6 = sext i32 %5 to i64
  %7 = getelementptr nusw %"class.cv::Point_.3569554", ptr %0, i64 %6
  ret ptr %7
}
...
entry:
  ...
  %5 = mul i32 %4, %1
  %6 = sext i32 %5 to i64
  %7 = getelementptr nusw %"class.cv::bgsegm::(anonymous namespace)::BackgroundSampleGSOC.3588017", ptr %0, i64 %6
  ret ptr %7
}
