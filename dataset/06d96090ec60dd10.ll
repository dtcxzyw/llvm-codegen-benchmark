...
entry:
  ...
  %5 = getelementptr nuw %"class.tbb::detail::d1::blocked_range.2635837", ptr %0, i64 %4, i32 1
  ret ptr %5
}
...
entry:
  ...
  %3 = and i8 %2, 7
  %4 = zext nneg i8 %3 to i64
  %5 = getelementptr nuw %"class.tbb::detail::d1::blocked_range.2637439", ptr %0, i64 %4, i32 1
  ret ptr %5
}
