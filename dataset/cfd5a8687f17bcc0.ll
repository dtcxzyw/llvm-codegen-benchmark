...
entry:
  %2 = add nsw i32 %1, 1
  %3 = shl nsw i32 %0, 1
  %4 = tail call range(i32 -2147483647, -2147483648) i32 @llvm.smax.i32(i32 %3, i32 range(i32 -2147483647, -2147483648) %2)
  ret i32 %4
}
...
entry:
  ...
  %3 = shl nsw i32 %0, 1
  %4 = tail call range(i32 8, -2147483648) i32 @llvm.smax.i32(i32 %3, i32 range(i32 8, -2147483648) %2)
  ret i32 %4
}
