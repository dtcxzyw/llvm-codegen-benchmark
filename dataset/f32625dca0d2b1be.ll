...
%"struct.irr::video::S3DVertex.1646467" = type { %"class.irr::core::vector3d.1646455", %"class.irr::core::vector3d.1646455", %"class.irr::video::SColor.1646454", %"class.irr::core::vector2d.1646468" }
%"class.irr::core::vector3d.1646455" = type { float, float, float }
%"class.irr::video::SColor.1646454" = type { i32 }
%"class.irr::core::vector2d.1646468" = type { float, float }
...
entry:
  ...
  %5 = getelementptr inbounds %"struct.irr::video::S3DVertex.1646467", ptr %1, i64 %4
  %6 = icmp eq ptr %0, %5
  ret i1 %6
}
