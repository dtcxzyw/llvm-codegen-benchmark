...
entry:
  %2 = fmul double %1, %1
  %3 = call double @llvm.fmuladd.f64(double %0, double 2.000000e+00, double -1.000000e+00)
  %4 = call double @llvm.fmuladd.f64(double %3, double %3, double %2)
...
entry:
  %2 = fmul double %1, %1
  %3 = call noundef double @llvm.fmuladd.f64(double %0, double 2.000000e+00, double -1.000000e+00)
  %4 = call double @llvm.fmuladd.f64(double %3, double %3, double %2)
  %5 = fcmp ogt double %4, 1.000000e+00
  ret i1 %5
}
