...
entry:
  ...
  %4 = sub i32 %1, %3
  %5 = xor i32 %4, %0
  %6 = tail call noundef i32 @llvm.fshl.i32(i32 %4, i32 %4, i32 11)
  %7 = sub i32 %5, %6
  ret i32 %7
}
...
entry:
  %3 = tail call i32 @llvm.fshl.i32(i32 %2, i32 %2, i32 18)
  %4 = sub i32 %1, %3
  %5 = xor i32 %4, %0
  %6 = tail call i32 @llvm.fshl.i32(i32 %4, i32 %4, i32 21)
  %7 = sub i32 %5, %6
  ret i32 %7
}
