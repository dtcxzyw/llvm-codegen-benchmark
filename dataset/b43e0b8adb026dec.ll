...
entry:
  %2 = shl nuw i64 1, %1
  %3 = getelementptr inbounds %"struct.rocksdb::StatisticsImpl::StatisticsData.1577804", ptr %0, i64 %2
  ret ptr %3
}
...
entry:
  %2 = shl nuw i64 1, %1
  %3 = getelementptr %"struct.rocksdb::clock_cache::AutoHyperClockTable::HandleImpl.1583117", ptr %0, i64 %2
  ret ptr %3
}
...
entry:
  ...
  %3 = getelementptr inbounds %"struct.tbb::detail::d2::hash_map_base<tbb::detail::d1::tbb_allocator<std::pair<const std::basic_string_view<char>, mold::elf::ComdatGroup>>, tbb::detail::d1::spin_rw_mutex>::bucket.1591804", ptr %0, i64 %2
  ret ptr %3
}
