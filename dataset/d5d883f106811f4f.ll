...
entry:
  ...
  %4 = getelementptr nusw nuw [4 x %struct.ossl_qrl_enc_level_st.2634709], ptr %1, i64 0, i64 %3
...
entry:
  %3 = zext i32 %2 to i64
  %4 = getelementptr nusw nuw [1 x %"struct.OT::IntType.2742031"], ptr %1, i64 0, i64 %3
  %5 = select i1 %0, ptr %4, ptr null
  ret ptr %5
}
...
entry:
  %3 = zext i32 %2 to i64
  %4 = getelementptr [2 x %struct.ata_device.3531598], ptr %1, i64 0, i64 %3
  %5 = select i1 %0, ptr %4, ptr null
  ret ptr %5
}
