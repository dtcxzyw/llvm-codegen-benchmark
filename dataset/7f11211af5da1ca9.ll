...
entry:
  %3 = zext i32 %2 to i64
  %4 = getelementptr nusw [305000 x %struct.deflate_optimum_node.2634602], ptr %1, i64 0, i64 %3
  %5 = icmp eq ptr %4, %0
  ret i1 %5
}
...
entry:
  %3 = zext i32 %2 to i64
  %4 = getelementptr nusw [1 x i8], ptr %1, i64 0, i64 %3
  %5 = icmp ugt ptr %4, %0
  ret i1 %5
}
...
entry:
  %3 = zext i32 %2 to i64
  %4 = getelementptr [4 x %struct.list_head.3342694], ptr %1, i64 0, i64 %3
  %5 = icmp eq ptr %4, %0
  ret i1 %5
}
...
entry:
  %3 = zext i32 %2 to i64
  %4 = getelementptr nusw [0 x %"struct.nix::Attr.3505213"], ptr %1, i64 0, i64 %3
  %5 = icmp ne ptr %4, %0
  ret i1 %5
}
