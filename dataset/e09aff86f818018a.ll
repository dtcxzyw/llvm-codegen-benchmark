...
%"class.llvm::MCInstrDesc.3101912" = type { i16, i16, i8, i8, i16, i8, i8, i16, i16, i64, i64 }
...
entry:
  ...
  %3 = sub nsw i64 0, %2
  %4 = getelementptr nusw { { i64, [2 x i64] }, { { i64, ptr }, i64 } }, ptr %0, i64 %3
...
entry:
  %2 = zext i16 %1 to i64
  %3 = sub nsw i64 0, %2
  %4 = getelementptr %"class.llvm::MCInstrDesc.3101912", ptr %0, i64 %3, i32 1
  ret ptr %4
}
