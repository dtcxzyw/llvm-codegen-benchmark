...
entry:
  ...
  %5 = getelementptr nuw %"class.QuantLib::Matrix.2850952", ptr %0, i64 %4, i32 2
  ret ptr %5
}
...
entry:
  %3 = call i32 @llvm.smin.i32(i32 %1, i32 %2)
  %4 = zext nneg i32 %3 to i64
  %5 = getelementptr %struct.CSN_DESCR.3451584, ptr %0, i64 %4, i32 4
  ret ptr %5
}
...
entry:
  %3 = tail call i32 @llvm.smin.i32(i32 %1, i32 %2)
  %4 = zext i32 %3 to i64
  %5 = getelementptr %struct.RangeBound.3651785, ptr %0, i64 %4, i32 1
  ret ptr %5
}
