...
; Function Attrs: nounwind
define i64 @func00000000000002b4(i64 %0, i64 %1, i64 %2) #0 {
entry:
  %3 = add nuw i64 %2, 1
  %4 = add nuw i64 %0, %1
  %5 = tail call noundef range(i64 1, 0) i64 @llvm.umax.i64(i64 range(i64 1, 0) %4, i64 range(i64 1, -2305843009213693957) %3)
  %6 = icmp samesign ult i64 %5, 4
  %7 = select i1 %6, i64 4, i64 8
  ret i64 %7
}
