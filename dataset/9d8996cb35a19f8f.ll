...
%"struct.eastl::pair.25.3716448" = type { %struct.TestObject.3716449, %struct.TestObject.3716449 }
%struct.TestObject.3716449 = type <{ i32, i8, [3 x i8], i64, i32, [4 x i8] }>
...
entry:
  ...
  %4 = add nsw i64 %3, %1
  %5 = sub nsw i64 0, %4
  %6 = getelementptr nusw %"struct.eastl::pair.25.3716448", ptr %0, i64 %5
  ret ptr %6
}
