...
entry:
  ...
  %6 = getelementptr nusw nuw [32 x %struct.anon.2935422], ptr %5, i64 0, i64 %4
  ret ptr %6
}
...
entry:
  ...
  %4 = zext nneg i32 %3 to i64
  %5 = getelementptr nusw nuw i8, ptr %0, i64 8
  %6 = getelementptr [5 x %struct.focaltech_finger_state.3536750], ptr %5, i64 0, i64 %4
  ret ptr %6
}
...
entry:
  ...
  %6 = getelementptr [31 x %struct.xhci_virt_ep.3539097], ptr %5, i64 0, i64 %4
  ret ptr %6
}
