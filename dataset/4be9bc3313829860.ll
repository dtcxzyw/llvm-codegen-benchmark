...
entry:
  %2 = call noundef double @llvm.fmuladd.f64(double %0, double %1, double 1.000000e+00)
  %3 = fcmp ogt double %2, 1.400000e+00
  %4 = select i1 %3, double 1.400000e+00, double %2
  ret double %4
}
