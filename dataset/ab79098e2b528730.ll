...
entry:
  ...
  %4 = getelementptr nusw nuw [4 x %"struct.rawspeed::VC5Decompressor::Channel.2871937"], ptr %3, i64 0, i64 %0
  %5 = sext i32 %1 to i64
  %6 = getelementptr nusw [4 x %"class.rawspeed::VC5Decompressor::Wavelet.2871939"], ptr %4, i64 0, i64 %5
  ret ptr %6
}
...
entry:
  ...
  %4 = getelementptr [2 x %struct.intel_excl_states.3533270], ptr %3, i64 0, i64 %0
  %5 = sext i32 %1 to i64
