...
; openjdk/optimized/rewriter.ll
; Function Attrs: nounwind
define i32 @func00000000000000de(i32 %0) #0 {
entry:
...
; openjdk/optimized/vectset.ll
; Function Attrs: nounwind
define i32 @func00000000000000df(i32 %0) #0 {
entry:
  %1 = add nuw nsw i32 %0, 1
  %2 = tail call range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %1, i1 true)
  %3 = sub nuw nsw i32 32, %2
...
; openjdk/optimized/phaseX.ll
; Function Attrs: nounwind
define i32 @func000000000000009e(i32 %0) #0 {
entry:
  %1 = add nuw i32 %0, 1
  %2 = tail call range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %1, i1 true)
  %3 = sub nuw nsw i32 32, %2
...
; Function Attrs: nounwind
define i32 @func000000000000004e(i32 %0) #0 {
entry:
  %1 = add nsw i32 %0, -1
  %2 = tail call range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %1, i1 false)
  %3 = sub nuw nsw i32 33, %2
...
; Function Attrs: nounwind
define i32 @func000000000000005d(i32 %0) #0 {
entry:
  %1 = add nsw i32 %0, -1
  %2 = call range(i32 0, 33) i32 @llvm.ctlz.i32(i32 range(i32 -2147483648, 2147483647) %1, i1 true)
