...
%"struct.Stockfish::Stats.30.2878592" = type { %"struct.std::array.31.2878593" }
%"struct.std::array.31.2878593" = type { [64 x %"class.Stockfish::StatsEntry.32.2878594"] }
%"class.Stockfish::StatsEntry.32.2878594" = type { i16 }
...
entry:
  ...
  %4 = getelementptr [16 x %struct.igb_tx.2705924], ptr %0, i64 0, i64 %3
  %5 = zext nneg i32 %1 to i64
  %6 = getelementptr [2 x %struct.e1000_adv_tx_context_desc.2705925], ptr %4, i64 0, i64 %5
  ret ptr %6
}
...
entry:
  %3 = zext i32 %2 to i64
  %4 = getelementptr nusw nuw [1 x %"struct.OT::AxisValueMap.2736812"], ptr %0, i64 0, i64 %3
  %5 = zext i32 %1 to i64
  %6 = getelementptr nusw nuw [2 x %"struct.OT::HBFixed.2736809"], ptr %4, i64 0, i64 %5
  ret ptr %6
}
...
entry:
  %3 = zext nneg i32 %2 to i64
  %4 = getelementptr nusw nuw [3 x %"struct.std::array.102.2872862"], ptr %0, i64 0, i64 %3
  %5 = zext nneg i32 %1 to i64
  %6 = getelementptr nusw nuw [41 x %"struct.rawspeed::(anonymous namespace)::int_pair.2872863"], ptr %4, i64 0, i64 %5
  ret ptr %6
}
...
entry:
  %3 = zext i32 %2 to i64
  %4 = getelementptr nusw nuw [16 x %"struct.Stockfish::Stats.30.2878592"], ptr %0, i64 0, i64 %3
  %5 = zext nneg i32 %1 to i64
  %6 = getelementptr nusw nuw [64 x %"class.Stockfish::StatsEntry.32.2878594"], ptr %4, i64 0, i64 %5
  ret ptr %6
}
...
entry:
  %3 = zext nneg i32 %2 to i64
  %4 = getelementptr nusw nuw [2 x %"struct.std::array.9.3496128"], ptr %0, i64 0, i64 %3
  %5 = zext i32 %1 to i64
  %6 = getelementptr nusw nuw [5 x %"class.absl::debian2::optional.3496085"], ptr %4, i64 0, i64 %5
  ret ptr %6
}
...
entry:
  %3 = zext i32 %2 to i64
  %4 = getelementptr [3 x %struct.anon.3556574], ptr %0, i64 0, i64 %3
  %5 = zext nneg i32 %1 to i64
  %6 = getelementptr [11 x %struct.ttm_pool_type.3556570], ptr %4, i64 0, i64 %5
  ret ptr %6
}
