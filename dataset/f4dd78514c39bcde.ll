...
%struct.gmx_moltype_t.3352860 = type { ptr, %struct.t_atoms.3352861, %"struct.std::array.254.3352833", %"class.gmx::ListOfLists.3352831" }
%struct.t_atoms.3352861 = type { i32, ptr, ptr, ptr, ptr, i32, ptr, ptr, i8, i8, i8, i8, i8 }
%"struct.std::array.254.3352833" = type { [94 x %struct.InteractionList.3352823] }
%struct.InteractionList.3352823 = type { %"class.std::vector.3352824" }
%"class.std::vector.3352824" = type { %"struct.std::_Vector_base.3352825" }
%"struct.std::_Vector_base.3352825" = type { %"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl.3352826" }
%"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl.3352826" = type { %"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data.3352827" }
%"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data.3352827" = type { ptr, ptr, ptr }
%"class.gmx::ListOfLists.3352831" = type { %"class.std::vector.3352824", %"class.std::vector.3352824" }
...
entry:
  ...
  %3 = getelementptr %struct.AHCIDevice.2709088, ptr %0, i64 %2, i32 5, i32 14
  ret ptr %3
}
...
entry:
  %2 = ashr exact i64 %1, 32
  %3 = getelementptr %"struct.std::pair.557.3228760", ptr %0, i64 %2, i32 1, i32 0, i32 0, i32 0, i32 1
  ret ptr %3
}
...
entry:
  %2 = ashr i64 %1, 32
  %3 = getelementptr %struct.gmx_moltype_t.3352860, ptr %0, i64 %2, i32 3, i32 1
  ret ptr %3
}
