...
%"class.tsl::detail_robin_hash::bucket_entry.306.1858515" = type { %"class.tsl::detail_robin_hash::bucket_entry_hash.1858513", i16, i8, i8, %"union.std::aligned_storage<16, 8>::type.1858514" }
%"class.tsl::detail_robin_hash::bucket_entry_hash.1858513" = type { i32 }
%"union.std::aligned_storage<16, 8>::type.1858514" = type { [16 x i8] }
