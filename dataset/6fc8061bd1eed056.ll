...
entry:
  ...
  %5 = getelementptr [512 x %struct.TCGTemp.2593549], ptr %0, i64 0, i64 %4
  ret ptr %5
}
...
entry:
  ...
  %4 = or disjoint i64 %3, %1
  %5 = getelementptr nusw [64 x %struct.hpdata_age_heap_t.3476691], ptr %0, i64 0, i64 %4
  ret ptr %5
}
...
entry:
  ...
  %4 = or disjoint i64 %3, %1
  %5 = getelementptr nusw [257 x i16], ptr %0, i64 0, i64 %4
  ret ptr %5
}
