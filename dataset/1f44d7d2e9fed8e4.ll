...
entry:
  %3 = zext i8 %0 to i64
  %4 = getelementptr [8 x %struct.SCC2698Channel.2707030], ptr %1, i64 0, i64 %2, i32 6, i64 %3
  ret ptr %4
}
...
entry:
  %3 = zext i8 %0 to i64
  %4 = getelementptr [4 x %struct.stbi__huffman.3399104], ptr %1, i64 0, i64 %2, i32 3, i64 %3
  ret ptr %4
}
