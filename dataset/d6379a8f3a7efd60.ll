...
entry:
  %3 = and i64 %1, %2
  %4 = getelementptr nuw %"struct.rocksdb::ConcurrentArena::Shard.2625596", ptr %0, i64 %3, i32 1
  ret ptr %4
}
...
entry:
  %3 = and i64 %1, %2
  %4 = getelementptr { { i64 }, { { [31 x i64] } } }, ptr %0, i64 %3, i32 1
  ret ptr %4
}
...
entry:
  %3 = and i64 %1, %2
  %4 = getelementptr %struct.CacheItem.2706779, ptr %0, i64 %3, i32 1
  ret ptr %4
}
