...
%struct.string_list_item.2772674 = type { ptr, ptr }
...
entry:
  %2 = getelementptr nusw %"class.re2::SparseArray<int>::IndexValue.2486787", ptr %0, i64 %1
...
entry:
  %2 = getelementptr nusw i16, ptr %0, i64 %1
...
entry:
  %2 = getelementptr %struct.string_list_item.2772674, ptr %0, i64 %1
...
entry:
  %2 = getelementptr nusw %"class.llvm::Use.2993135", ptr %0, i64 %1
...
; raylib/optimized/rtextures.c.ll
; Function Attrs: nounwind
define i1 @func00000000000000a9(ptr %0, i64 %1) #0 {
entry:
  %2 = getelementptr nusw %struct.stbir__contributors.3609572, ptr %0, i64 %1
  %3 = getelementptr nusw i8, ptr %2, i64 -8
  %4 = icmp uge ptr %3, %0
  ret i1 %4
}
