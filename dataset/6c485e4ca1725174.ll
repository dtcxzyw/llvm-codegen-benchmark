...
entry:
  ...
  %4 = getelementptr nusw %"struct.rocksdb::TableReader::Anchor.2504818", ptr %0, i64 %.neg
  ret ptr %4
}
...
entry:
  %3 = sub i64 %1, %2
  %.neg = sdiv exact i64 %3, -40
  %4 = getelementptr %"struct.mold::elf::DynamicPattern.2525528", ptr %0, i64 %.neg
  ret ptr %4
}
...
entry:
  ...
  %4 = getelementptr %"class.irr::core::vector3d.2577639", ptr %0, i64 %.neg
