...
entry:
  %2 = sext i8 %1 to i64
  %3 = getelementptr nusw [2 x %"struct.G1PLABAllocator::PLABData.2625867"], ptr %0, i64 0, i64 %2
  ret ptr %3
}
...
entry:
  %2 = sext i8 %1 to i64
  %3 = getelementptr [100 x %struct.dt_liquify_path_data_t.2761282], ptr %0, i64 0, i64 %2
  ret ptr %3
}
