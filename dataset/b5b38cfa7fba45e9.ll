...
entry:
  ...
  %4 = getelementptr [512 x %struct.TCGTemp.2707225], ptr %3, i64 0, i64 %2
...
entry:
  ...
  %4 = getelementptr nusw [3058 x %"class.facebook::velox::CompactDoubleList.2799404"], ptr %3, i64 0, i64 %2
  %5 = ptrtoint ptr %4 to i64
  ret i64 %5
}
