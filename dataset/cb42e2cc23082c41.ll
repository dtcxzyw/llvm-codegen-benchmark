...
entry:
  ...
  %6 = add i64 %1, %5
  %7 = getelementptr %"struct.rocksdb::TransactionBaseImpl::SavePoint.1565008", ptr %0, i64 %6
  ret ptr %7
}
...
entry:
  ...
  %6 = add nsw i64 %5, %1
  %7 = getelementptr inbounds %"struct.rocksdb::(anonymous namespace)::UniversalCompactionBuilder::SortedRun.1583075", ptr %0, i64 %6
  ret ptr %7
}
...
entry:
  ...
  %6 = add i64 %1, %5
  %7 = getelementptr inbounds %"struct.mold::elf::ElfPhdr.1590044", ptr %0, i64 %6
  ret ptr %7
}
