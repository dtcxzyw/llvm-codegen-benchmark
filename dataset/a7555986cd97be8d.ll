...
%struct.b3GpuSolverConstraint.2705098 = type { %class.b3Vector3.2705088, %class.b3Vector3.2705088, %class.b3Vector3.2705088, %class.b3Vector3.2705088, %class.b3Vector3.2705088, float, float, i32, i32, float, float, float, float, float, float, float, %union.anon.51.2705099, i32, i32, i32, i32, [8 x i8] }
%class.b3Vector3.2705088 = type { %union.anon.2705090 }
%union.anon.2705090 = type { [4 x float] }
%union.anon.51.2705099 = type { ptr }
...
entry:
  ...
  %5 = getelementptr nusw %struct.OnigMatchParamStruct.2596902, ptr %4, i64 %0
...
entry:
  %3 = sext i32 %2 to i64
  %4 = getelementptr %struct.b3GpuSolverConstraint.2705098, ptr %1, i64 %3
  %5 = getelementptr %struct.b3GpuSolverConstraint.2705098, ptr %4, i64 %0, i32 5
  ret ptr %5
}
...
entry:
  %3 = sext i32 %2 to i64
  %4 = getelementptr nusw %struct.TPL_MV_REF.3194448, ptr %1, i64 %3
  %5 = getelementptr %struct.TPL_MV_REF.3194448, ptr %4, i64 %0, i32 1
  ret ptr %5
}
