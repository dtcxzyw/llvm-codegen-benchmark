...
entry:
  ...
  %6 = getelementptr [2 x %struct.e1000_adv_tx_context_desc.1661145], ptr %4, i64 0, i64 %5, i32 2
  ret ptr %6
}
...
entry:
  ...
  %5 = zext nneg i32 %1 to i64
  %6 = getelementptr inbounds [41 x %"struct.rawspeed::(anonymous namespace)::int_pair.1767430"], ptr %4, i64 0, i64 %5, i32 1
  ret ptr %6
}
...
entry:
  %3 = zext i32 %2 to i64
  %4 = getelementptr inbounds [1 x %"struct.OT::AxisValueMap.2272988"], ptr %0, i64 0, i64 %3
  %5 = zext i32 %1 to i64
  %6 = getelementptr inbounds [2 x %"struct.OT::HBFixed.2272987"], ptr %4, i64 0, i64 %5, i32 0, i32 0, i32 0, i64 1
  ret ptr %6
}
