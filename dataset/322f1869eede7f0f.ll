...
entry:
  ...
  %6 = getelementptr nusw [2 x %struct.Lf_Plc_t_.2765485], ptr %5, i64 0, i64 %4
  ret ptr %6
}
...
; Function Attrs: nounwind
define ptr @func0000000000000188(ptr %0, i32 %1, i32 %2) #0 {
entry:
  %3 = icmp ne i32 %1, %2
  %4 = zext i1 %3 to i64
  %5 = getelementptr nusw i8, ptr %0, i64 24
  %6 = getelementptr [2 x %struct.ssh_peer_data.3262822], ptr %5, i64 0, i64 %4
  ret ptr %6
}
...
entry:
  %3 = icmp sle i32 %1, %2
  %4 = zext i1 %3 to i64
  %5 = getelementptr nusw i8, ptr %0, i64 1264
  %6 = getelementptr nusw [2 x ptr], ptr %5, i64 0, i64 %4
  ret ptr %6
}
