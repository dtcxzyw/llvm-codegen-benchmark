...
entry:
  ...
  %5 = getelementptr [1 x %"struct.OT::IntType.139.2623439"], ptr %4, i64 0, i64 %3, i32 0, i32 0, i64 1
  ret ptr %5
}
...
entry:
  ...
  %5 = getelementptr [2 x %"struct.gjkepa2_impl::GJK::sSimplex.2705732"], ptr %4, i64 0, i64 %3, i32 2
  ret ptr %5
}
...
entry:
  ...
  %5 = getelementptr [2 x %struct.ata_device.3342556], ptr %4, i64 0, i64 %3, i32 11
  ret ptr %5
}
...
entry:
  ...
  %5 = getelementptr [6 x %struct.hwloc_special_level_s.3678210], ptr %4, i64 0, i64 %3, i32 1
  ret ptr %5
}
...
entry:
  ...
  %3 = zext i32 %2 to i64
  %4 = getelementptr nusw i8, ptr %0, i64 256
  %5 = getelementptr [6 x %struct.hwloc_special_level_s.3678235], ptr %4, i64 0, i64 %3, i32 1
  ret ptr %5
}
