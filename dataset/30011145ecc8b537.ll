...
entry:
  %3 = zext nneg i32 %2 to i64
  %4 = getelementptr nusw nuw [3 x %"struct.std::array.102.2872896"], ptr %1, i64 0, i64 %3
  %5 = getelementptr nuw [41 x %"struct.rawspeed::(anonymous namespace)::int_pair.2872897"], ptr %4, i64 0, i64 %0, i32 1
  ret ptr %5
}
...
entry:
  ...
  %5 = getelementptr [8 x %struct.skl_wm_level.3534311], ptr %4, i64 0, i64 %0, i32 3
  ret ptr %5
}
