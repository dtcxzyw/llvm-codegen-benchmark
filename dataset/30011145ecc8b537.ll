...
entry:
  %3 = zext nneg i32 %2 to i64
  %4 = getelementptr nusw [3 x %"struct.std::array.102.2760618"], ptr %1, i64 0, i64 %3
  %5 = getelementptr [41 x %"struct.rawspeed::(anonymous namespace)::int_pair.2760619"], ptr %4, i64 0, i64 %0, i32 1
  ret ptr %5
}
...
entry:
  ...
  %5 = getelementptr [8 x %struct.skl_wm_level.3345619], ptr %4, i64 0, i64 %0, i32 3
  ret ptr %5
}
