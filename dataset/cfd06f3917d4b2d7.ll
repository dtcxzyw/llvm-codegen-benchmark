...
entry:
  ...
  %4 = add i64 %1, %2
  %5 = xor i64 %4, %3
  %6 = tail call i64 @llvm.fshl.i64(i64 %5, i64 %5, i64 17)
  %7 = xor i64 %6, %0
  ret i64 %7
}
...
entry:
  %3 = add nsw i64 %1, %2
  %4 = tail call i64 @llvm.fshl.i64(i64 %1, i64 %1, i64 42)
  %5 = xor i64 %4, %3
...
entry:
  %3 = tail call noundef i64 @llvm.fshl.i64(i64 %2, i64 %2, i64 16)
  %4 = add i64 %1, %2
  %5 = xor i64 %4, %3
  %6 = tail call noundef i64 @llvm.fshl.i64(i64 %5, i64 %5, i64 21)
  %7 = xor i64 %6, %0
  ret i64 %7
}
...
entry:
  %3 = add i64 %1, %2
  %4 = tail call noundef i64 @llvm.fshl.i64(i64 %1, i64 %1, i64 16)
  %5 = xor i64 %4, %3
  %6 = tail call noundef i64 @llvm.fshl.i64(i64 %5, i64 %5, i64 21)
  %7 = xor i64 %6, %0
  ret i64 %7
