...
%"struct.boost::container::dtl::pair.1862216" = type <{ %"class.std::thread::id.1862217", i32, [4 x i8] }>
%"class.std::thread::id.1862217" = type { i64 }
...
entry:
  %3 = getelementptr inbounds %"struct.boost::container::dtl::pair.1862216", ptr %1, i64 %2
  %4 = icmp ne ptr %3, %0
