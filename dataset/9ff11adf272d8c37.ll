...
entry:
  ...
  %6 = getelementptr nusw %"class.Ipopt::TripletToCSRConverter::TripletEntry.2611456", ptr %5, i64 %4
  ret ptr %6
}
...
entry:
  ...
  %6 = getelementptr %"class.std::vector.112.2823522", ptr %5, i64 %4
  ret ptr %6
}
...
entry:
  ...
  %5 = getelementptr i8, ptr %0, i64 8
  %6 = getelementptr nusw %"struct.duckdb::UnifiedVectorFormat.2951737", ptr %5, i64 %4
  ret ptr %6
}
...
entry:
  ...
  %6 = getelementptr nusw %"struct.llvm::ValueDFS.3317719", ptr %5, i64 %4
  ret ptr %6
}
