...
entry:
  ...
  %6 = getelementptr nusw %"class.Ipopt::TripletToCSRConverter::TripletEntry.2496215", ptr %5, i64 %4
  ret ptr %6
}
...
entry:
  ...
  %6 = getelementptr %"class.std::vector.112.2710966", ptr %5, i64 %4
  ret ptr %6
}
