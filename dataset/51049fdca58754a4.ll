...
%"struct.(anonymous namespace)::MovableType.3717835" = type { ptr }
...
entry:
  %3 = add nsw i64 %2, 1
  %4 = call i64 @llvm.umax.i64(i64 %3, i64 %1)
  %5 = getelementptr %"class.(anonymous namespace)::NotTriviallyDestructible.3284437", ptr %0, i64 %4
  ret ptr %5
}
...
entry:
  ...
  %5 = getelementptr nusw %"struct.(anonymous namespace)::MovableType.3717835", ptr %0, i64 %4
  ret ptr %5
}
