...
entry:
  ...
  %3 = getelementptr inbounds [14 x %"union.std::aligned_storage<8, 8>::type.1637575"], ptr %0, i64 0, i64 %2
  %4 = ptrtoint ptr %3 to i64
  ret i64 %4
}
...
entry:
  %2 = zext i32 %1 to i64
  %3 = getelementptr inbounds [256 x %struct.epoll_event.1745790], ptr %0, i64 0, i64 %2
  %4 = ptrtoint ptr %3 to i64
  ret i64 %4
}
...
entry:
  ...
  %3 = getelementptr [38 x %struct.dsa_area_pool.2121336], ptr %0, i64 0, i64 %2
  %4 = ptrtoint ptr %3 to i64
  ret i64 %4
}
