...
%"struct.Node_Stack::INode.2741801" = type { ptr, i32 }
...
entry:
  ...
  %5 = getelementptr nusw nuw %"struct.Node_Stack::INode.2741801", ptr %0, i64 %4
  ret ptr %5
}
...
entry:
  ...
  %4 = zext nneg i32 %3 to i64
  %5 = getelementptr nusw nuw %"class.std::vector.5.3434033", ptr %0, i64 %4
  ret ptr %5
}
